...
local categories = {
    {
        ...
        options = {
            ...
            Section(L["DASH_APPEARANCE"] or "Appearance"),
            ...
            Section(L["INSIGHT_SECTION_COMBAT"] or "Combat"),
            ...
            Section(L["INSIGHT_SECTION_ICONS_AND_SEPARATORS"] or "Icons & separators"),
    ...
    },
    {
        ...
        options = {
            Section(L["INSIGHT_SECTION_IDENTITY"] or "Identity"),
            ...
            Color(L["INSIGHT_TITLE_CUSTOM_COLOUR"] or "Custom Color", L["AXIS_COLOUR_OF_CHARACTER_TITLE_PLAYER_TOOLTIP"] or "Color of the character title in the player tooltip name line.", "insightTitleColor", { 1.00, 0.82, 0.00 }, { visibleWhen = function()
            ...
            Section(L["INSIGHT_SECTION_STATUS_PVP"] or "Status"),
            ...
            Section(L["INSIGHT_SECTION_RATINGS_GEAR"] or "Ratings & gear"),
            ...
            Section(L["INSIGHT_SECTION_MOUNT"] or "Mount"),
            ...
            Section(L["INSIGHT_SECTION_CLASS"] or "Class"),
            ...
            Section(L["FOCUS_FONT_SIZES"] or "Font sizes"),
            Slider(L["FOCUS_HEADER_SIZE"] or "Header size",         L["FOCUS_HEADER_FONT_SIZE"] or "Header font size for player tooltips.",                                                 "insightPlayerHeaderSize",  8, 24, 14),
            Slider(L["INSIGHT_BODY_SIZE"] or "Body size",           L["INSIGHT_BODY_FONT_SIZE"] or "Body font size for player tooltips.",                                                   "insightPlayerBodySize",    8, 20, 12),
            Slider(L["INSIGHT_BADGES_SIZE"] or "Status badge size", L["INSIGHT_BADGES_FONT_SIZE"] or "Font size for status badges on player tooltips.",                                    "insightPlayerBadgesSize",  6, 20, 12),
            Slider(L["INSIGHT_STATS_SIZE"] or "Ratings size",       L["INSIGHT_STATS_FONT_SIZE"] or "Font size for Mythic+ score, item level, and honor level on player tooltips.",        "insightPlayerStatsSize",   6, 20, 11),
            Slider(L["INSIGHT_MOUNT_SIZE"] or "Mount size",         L["INSIGHT_MOUNT_FONT_SIZE"] or "Mount name, source, and ownership font size for player tooltips.",                    "insightPlayerMountSize",   6, 20, 11),
        },
    },
    {
        key = "InsightNpc",
        ...
        options = {
            Section(L["INSIGHT_SECTION_NPC_TOOLTIP"] or "NPC tooltip"),
            ...
            Section(L["FOCUS_FONT_SIZES"] or "Font sizes"),
            Slider(L["FOCUS_HEADER_SIZE"] or "Header size", L["FOCUS_HEADER_FONT_SIZE"] or "Header font size for NPC tooltips.", "insightNpcHeaderSize", 8, 24, 14),
            Slider(L["INSIGHT_BODY_SIZE"] or "Body size",   L["INSIGHT_BODY_FONT_SIZE"] or "Body font size for NPC tooltips.",   "insightNpcBodySize",   8, 20, 12),
        },
    },
    {
        key = "InsightItem",
        ...
        options = {
            Section(L["INSIGHT_SECTION_TRANSMOG"] or "Transmog"),
            ...
            Section(L["INSIGHT_SECTION_ITEM_STYLING"] or "Item styling"),
            ...
            Section(L["FOCUS_FONT_SIZES"] or "Font sizes"),
            Slider(L["FOCUS_HEADER_SIZE"] or "Header size",    L["FOCUS_HEADER_FONT_SIZE"] or "Header font size for item tooltips (item name line).",        "insightItemHeaderSize",   8, 24, 14),
            Slider(L["INSIGHT_BODY_SIZE"] or "Body size",      L["INSIGHT_BODY_FONT_SIZE"] or "Body font size for item tooltips (stats and middle zone).",    "insightItemBodySize",     8, 20, 12),
