...
local categories = {
    ...
    },
    {
        ...
        options = {
            ...
            Toggle("Custom Colour", "Use the player's TRP3 custom name colour instead of their faction or class colour", "insightTRP3CustomColor", true),
            Toggle("Pronouns", "Show the player's TRP3 pronouns in the name line", "insightTRP3Pronouns", true),
            ...
            Toggle("Full Title", "Show the player's full title (e.g. < Keeper of the Dawnguard >) as a line below the name", "insightTRP3Title", true), 
            Toggle("Custom Race & Class", "Show the player's TRP3 race/class near the bottom when available. The native race/class line moves there as a fallback", "insightTRP3RaceClass", true),
            Toggle("Custom Guild", "Show the player's TRP3 guild near the bottom when available. The native guide line moves there as a fallback", "insightTRP3Guild", true),
            Toggle("Currently", "Show the player's TRP3 'Currently' status text as a block at the bottom of the tooltip", "insightTRP3Currently", true),
        },
    },
    {
        key = "InsightNpc",
