...
local categories = {
    ...
    },
    {
        ...
        options = {
            ...
            Toggle(L["INSIGHT_SPEC_NAME"], L["INSIGHT_SPEC_NAME_DESC"], "insightShowSpecName", D.insightShowSpecName, { isNew = "5.7.0" }),
            Toggle(L["INSIGHT_HERO_TALENT"], L["INSIGHT_HERO_TALENT_DESC"], "insightShowHeroTalent", D.insightShowHeroTalent, { isNew = "5.7.0" }),
