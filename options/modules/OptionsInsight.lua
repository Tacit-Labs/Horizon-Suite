...
local categories = {
    ...
    },
    {
        ...
        options = {
            ...
            Toggle(L["INSIGHT_SPEC_NAME"], L["INSIGHT_SPEC_NAME_DESC"], "insightShowSpecName", D.insightShowSpecName, { requires = "specs", isNew = "5.7.0" }),
            Toggle(L["INSIGHT_HERO_TALENT"], L["INSIGHT_HERO_TALENT_DESC"], "insightShowHeroTalent", D.insightShowHeroTalent, { requires = "heroTalents", isNew = "5.7.0" }),
            Toggle(L["INSIGHT_SPEC_ROLE"], L["INSIGHT_SPEC_ROLE_DESC"], "insightShowSpecRole", D.insightShowSpecRole, { requires = "specs" }),
    ...
    },
    {
        ...
        options = {
            ...
            { type = "dropdown", name = L["INSIGHT_TRP3_WOW_TITLE"], desc = L["INSIGHT_TRP3_WOW_TITLE_DESC"], dbKey = "insightTRP3WowTitle", options = INSIGHT_FORCE_MODIFIER_OPTIONS, preserveOrder = true, get = function() return getDB("insightTRP3WowTitle", "force") end, set = function(v) setDB("insightTRP3WowTitle", v) end, visibleWhen = function() return getDB("insightTRP3RPName", true) end },
