...
local categories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "dropdown", name = L["PRESENCE_DISCOVERY_FONT"], desc = L["PRESENCE_FONT_FAMILY_DISCOVERY"], dbKey = "presenceDiscoveryFontPath", searchable = true, options = function() return GetPerElementFontDropdownOptions("presenceDiscoveryFontPath") end, get = function() return getDB("presenceDiscoveryFontPath", FONT_USE_GLOBAL) end, set = function(v) setDB("presenceDiscoveryFontPath", v) if addon.Presence and addon.Presence.ApplyPresenceOptions then addon.Presence.ApplyPresenceOptions() end end, displayFn = DisplayPerElementFont, refreshIds = { "presencePreview" }, fontPreviewInList = true },
            { type = "dropdown", name = L["PRESENCE_DISCOVERY_OUTLINE"], desc = L["PRESENCE_FONT_OUTLINE_DISCOVERY"], dbKey = "presenceDiscoveryFontOutline", options = OUTLINE_OPTIONS, preserveOrder = true, get = function() return getDB("presenceDiscoveryFontOutline", D.presenceDiscoveryFontOutline) end, set = function(v) setDB("presenceDiscoveryFontOutline", v) if addon.Presence and addon.Presence.ApplyPresenceOptions then addon.Presence.ApplyPresenceOptions() end end, refreshIds = { "presencePreview" } },
