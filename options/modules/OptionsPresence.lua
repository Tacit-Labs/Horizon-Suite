...
local categories = {
    {
        ...
        options = {
            ...
            Toggle(L["TOAST_ICONS"], L["PRESENCE_QUEST_TYPE_ICON_PRESENCE_TOASTS_QUEST"], "showPresenceQuestTypeIcons", true, { refreshIds = { "presencePreview" } }),
            ...
            Toggle(L["PRESENCE_HIDE_QUEST_UPDATE_TITLE"], L["OBJECTIVE_LINE"], "presenceHideQuestUpdateTitle", false, { tooltip = L["PRESENCE_OBJECTIVE_LINE_QUEST_PROGRESS_TOAST"], refreshIds = { "presencePreview" } }),
            Toggle(L["PRESENCE_DISCOVERY_LINE"], L["PRESENCE_SHOW_DISCOVERED"], "showPresenceDiscovery", true, { refreshIds = { "presencePreview" } }),
            ...
            Toggle(L["FOCUS_ANIMATIONS"], L["PRESENCE_ENABLE_ENTRANCE_EXIT_ANIMATIONS_PRESENCE"], "presenceAnimations", true),
    ...
    },
    {
        ...
        options = {
            ...
            Toggle(L["ZONE_ENTRY"], L["PRESENCE_ZONE_CHANGE_ENTERING_A_AREA"], "presenceZoneChange", true, { refreshIds = { "presenceSubzoneChange", "presenceHideZoneForSubzone" } }),
            ...
            Toggle(L["VISTA_SHOW_SUBZONE"], L["SUBZONE_NAME_WITHIN_SAME_ZONE"], "presenceHideZoneForSubzone", false, { tooltip = L["ZONE_NAME_NEW_ZONE"], visibleWhen = function() local v = getDB("presenceSubzoneChange", nil); if v ~= nil then return v end; return getDB("presenceZoneChange", true) end }),
            Toggle(L["SUPPRESS_M"], L["HIDE_ZONE_NOTIFICATIONS_MYTHIC"], "presenceSuppressZoneInMplus", true, { tooltip = L["BOSS_EMOTES_ACHIEVEMENTS_LEVEL_HIDES_ZONE"] }),
            Section(L["INSTANCE_SUPPRESSION"]),
            Toggle(L["SUPPRESS_DUNGEON"],    L["SUPPRESS_NOTIFICATIONS_DUNGEONS"],                            "presenceSuppressInDungeon",     false, { tooltip = L["SUPPRESS_IN_DUNGEON_DETAIL"] }),
            Toggle(L["PRESENCE_SUPPRESS_DELVE"], L["PRESENCE_SUPPRESS_SCENARIO_PROGRESS_NOTIFICATIONS_DELVES"], "presenceSuppressInDelve",    false, { tooltip = L["PRESENCE_HIDE_DELVE_OBJECTIVE_UPDATE"] }),
            Toggle(L["SUPPRESS_RAID"],       L["SUPPRESS_IN_RAID_DETAIL"],                                    "presenceSuppressInRaid",        false),
            Toggle(L["SUPPRESS_PVP"],        L["SUPPRESS_IN_ARENA_DETAIL"],                                   "presenceSuppressInPvP",         false),
            Toggle(L["SUPPRESS_BATTLEGROUND"], L["SUPPRESS_PRESENCE_NOTIFICATIONS_WHILE_INSIDE_A"],           "presenceSuppressInBattleground", false),
            Toggle(L["PRESENCE_LEVEL_UP_TOGGLE"], L["PRESENCE_LEVEL_NOTIFICATION"],                           "presenceLevelUp",               true),
            Toggle(L["BOSS_EMOTES"],         L["PRESENCE_RAID_DUNGEON_BOSS_EMOTE_NOTIFICATIONS"],             "presenceBossEmote",             true),
            Toggle(L["FOCUS_ACHIEVEMENTS"],  L["PRESENCE_ACHIEVEMENT_EARNED_NOTIFICATIONS"],                  "presenceAchievement",           true),
            Toggle(L["PRESENCE_ACHIEVEMENT_PROGRESS"], L["NOTIFY_ACHIEVEMENT_CRITERIA_UPDATE"],               "presenceAchievementProgress",   false, { tooltip = L["PRESENCE_NOTIFICATION_ACHIEVEMENT_CRITERIA_UPDATE"] }),
            ...
            Toggle(L["PRESENCE_OBJECTIVE"], L["PRESENCE_QUEST_PROGRESS_HIDE_TITLE"], "presenceHideQuestUpdateTitle", false),
            ...
            Toggle(L["PRESENCE_SHOW_RARE_DEFEATED"], L["NOTIFICATION_A_RARE_MOB_DEFEATED_NEARBY"], "presenceRareDefeated", true),
        },
    },
    {
        ...
        options = {
            ...
            Toggle(L["COLOUR_ZONE_TYPE"], L["COLOUR_ZONE_SUBZONE_TITLES_PVP_ZONE"], "presenceZoneTypeColoring", false, { refreshIds = { "presencePreview" } }),
