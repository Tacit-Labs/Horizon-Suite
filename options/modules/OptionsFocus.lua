...
local categories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "dropdown", name = L["SORT_MODE"], desc = L["FOCUS_ENTRY_NUMBER_IN_CATEGORY"], dbKey = "entrySortMode", options = { { L["FOCUS_ALPHABETICAL"], "alpha" }, { L["FOCUS_QUEST_TYPE"], "questType" }, { L["FOCUS_ZONE"], "zone" }, { L["FOCUS_QUEST_LEVEL"], "level" }, { L["FOCUS_PROXIMITY"], "proximity" } }, get = function() return getDB("entrySortMode", D.entrySortMode) end, set = function(v) setDB("entrySortMode", v); if v == "proximity" and addon.focus then addon.focus.proximityDirty = true end; if addon.ScheduleRefresh then addon.ScheduleRefresh() end end },
        },
    },
    {
        key = "Typography",
