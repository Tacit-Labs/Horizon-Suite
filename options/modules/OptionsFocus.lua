...
local categories = {
    {
        ...
        options = {
            ...
            { type = "dropdown", name = L["FOCUS_FRAME_STRATA"], desc = L["FOCUS_FRAME_STRATA_DESC"], tooltip = L["FOCUS_FRAME_STRATA_TOOLTIP"], dbKey = "focusFrameStrata", searchable = true, isNew = "5.8.0", options = GetFocusFrameStrataOptions, get = function() return addon.GetFocusFrameStrata() end, set = function(v) setDB("focusFrameStrata", v) end },
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = L["FOCUS_BACKDROP_MOUSEOVER"], desc = L["FOCUS_BACKDROP_MOUSEOVER_DESC"], dbKey = "backdropOpacityOnMouseover", get = function() return getDB("backdropOpacityOnMouseover", D.backdropOpacityOnMouseover) end, set = function(v) setDB("backdropOpacityOnMouseover", v); if addon.ApplyBackdropOpacity then addon.ApplyBackdropOpacity() end; if addon.EnsureFocusUpdateRunning then addon.EnsureFocusUpdateRunning() end end, refreshIds = { "backdropOpacityMouseover" } },
            { type = "slider", name = L["FOCUS_BACKDROP_MOUSEOVER_OPACITY"], desc = L["FOCUS_BACKDROP_MOUSEOVER_OPACITY_DESC"], dbKey = "backdropOpacityMouseover", min = LIM.backdropOpacityMouseover.min, max = LIM.backdropOpacityMouseover.max, get = function() local v = tonumber(getDB("backdropOpacityMouseover", D.backdropOpacityMouseover)) or D.backdropOpacityMouseover; if v <= 1 and v > 0 then return math.floor(v * 100 + 0.5) end; return math.max(LIM.backdropOpacityMouseover.min, math.min(LIM.backdropOpacityMouseover.max, v)) end, set = function(v) setDB("backdropOpacityMouseover", clamp(v, "backdropOpacityMouseover") / 100) end, visibleWhen = function() return getDB("backdropOpacityOnMouseover", D.backdropOpacityOnMouseover) end },
            ...
            Toggle(L["FOCUS_BORDER"], L["FOCUS_BORDER_AROUND_TRACKER"], "showBorder", D.showBorder, { refreshIds = { "showBorderOnMouseover" } }),
            { type = "toggle", name = L["FOCUS_BORDER_MOUSEOVER"], desc = L["FOCUS_BORDER_MOUSEOVER_DESC"], dbKey = "showBorderOnMouseover", get = function() return getDB("showBorderOnMouseover", D.showBorderOnMouseover) end, set = function(v) setDB("showBorderOnMouseover", v); if addon.ApplyBorderVisibility then addon.ApplyBorderVisibility() end; if addon.EnsureFocusUpdateRunning then addon.EnsureFocusUpdateRunning() end end, disabled = function() return getDB("showBorder", D.showBorder) end },
    ...
    },
    {
        ...
        options = {
            ...
            { requires = "mythicPlus", type = "toggle", name = L["MYTHIC_PLUS_DUNGEON"], desc = L["TRACKER_MYTHIC_KEYSTONES"], dbKey = "showInDungeonMythicPlus", id = "showInDungeonMythicPlus", visibleWhen = function() return getDB("showInDungeon", D.showInDungeon) end, get = function() local v = getDB("showInDungeonMythicPlus", nil); if v ~= nil then return v end; return getDB("showInDungeon", D.showInDungeon) end, set = function(v) setDB("showInDungeonMythicPlus", v) end },
            ...
            Section(L["MYTHIC_BLOCK"], { requires = "mythicPlus" }),
            Toggle(L["ENABLE_M_BLOCK"], L["FOCUS_TIMER_COMPLETION_AFFIXES_MYTHIC_DUNGEONS"], "showMythicPlusBlock", D.showMythicPlusBlock, { requires = "mythicPlus", refreshIds = { "mplusAlwaysShow", "mplusShowAffixIcons", "mplusShowAffixDescriptions", "mplusShowSplitTimer", "mplusBlockPosition", "mplusBossCompletedDisplay" } }),
            { requires = "mythicPlus", type = "toggle", name = L["FOCUS_SHOW_SPLIT_TIMER"], desc = L["FOCUS_SHOW_SPLIT_TIMER_DESC"], dbKey = "mplusShowSplitTimer", id = "mplusShowSplitTimer", visibleWhen = function() return getDB("showMythicPlusBlock", D.showMythicPlusBlock) end, get = function() return getDB("mplusShowSplitTimer", D.mplusShowSplitTimer) end, set = function(v) setDB("mplusShowSplitTimer", v); if addon.UpdateMplusBlock then addon.UpdateMplusBlock() end end },
            { requires = "mythicPlus", type = "toggle", name = L["ALWAYS"], desc = L["ALWAYS_M_TIMER"], tooltip = L["M_BLOCK_WHENEVER_AN_ACTIVE_KEYSTONE"], dbKey = "mplusAlwaysShow", id = "mplusAlwaysShow", visibleWhen = function() return getDB("showMythicPlusBlock", D.showMythicPlusBlock) end, get = function() return getDB("mplusAlwaysShow", D.mplusAlwaysShow) end, set = function(v) setDB("mplusAlwaysShow", v); if addon.FullLayout then addon.FullLayout() end end },
            Toggle(L["AFFIX_ICONS"], L["FOCUS_AFFIX_ICONS_NEXT_MODIFIER_NAMES_M"], "mplusShowAffixIcons", D.mplusShowAffixIcons, { requires = "mythicPlus", id = "mplusShowAffixIcons", visibleWhen = function() return getDB("showMythicPlusBlock", D.showMythicPlusBlock) end }),
            Toggle(L["AFFIX_TOOLTIPS"], L["FOCUS_AFFIX_DESCRIPTIONS_HOVERING_M_BLO"], "mplusShowAffixDescriptions", D.mplusShowAffixDescriptions, { requires = "mythicPlus", id = "mplusShowAffixDescriptions", visibleWhen = function() return getDB("showMythicPlusBlock", D.showMythicPlusBlock) end }),
            { requires = "mythicPlus", type = "dropdown", name = L["BLOCK_POSITION"], desc = L["FOCUS_POSITION_OF_MYTHIC_BLOCK_RELATIVE_QUEST"], dbKey = "mplusBlockPosition", id = "mplusBlockPosition", visibleWhen = function() return getDB("showMythicPlusBlock", D.showMythicPlusBlock) end, options = MPLUS_POSITION_OPTIONS, get = function() return getDB("mplusBlockPosition", D.mplusBlockPosition) end, set = function(v) setDB("mplusBlockPosition", v) end },
            { requires = "mythicPlus", type = "dropdown", name = L["COMPLETED_BOSS_STYLE"], desc = L["DEFEATED_BOSS_STYLE"], tooltip = L["FOCUS_DEFEATED_BOSSES_CHECKMARK_ICON_GREEN"], dbKey = "mplusBossCompletedDisplay", id = "mplusBossCompletedDisplay", visibleWhen = function() return getDB("showMythicPlusBlock", D.showMythicPlusBlock) end, options = { { L["FOCUS_CHECKMARK"], "tick" }, { L["FOCUS_GREEN_COLOUR"], "green" } }, get = function() return getDB("mplusBossCompletedDisplay", D.mplusBossCompletedDisplay) end, set = function(v) setDB("mplusBossCompletedDisplay", v); if addon.UpdateMplusBlock then addon.UpdateMplusBlock() end end },
            Section(L["FOCUS_MYTHIC_TYPOGRAPHY"], { requires = "mythicPlus", defaultCollapsed = true }),
            { requires = "mythicPlus", type = "slider", name = L["FOCUS_DUNGEON_NAME_SIZE"], desc = L["FOCUS_FONT_SIZE_DUNGEON_NAME_PX"], dbKey = "mplusDungeonSize", min = LIM.mplusDungeonSize.min, max = LIM.mplusDungeonSize.max, step = 1, get = function() return math.max(LIM.mplusDungeonSize.min, math.min(LIM.mplusDungeonSize.max, tonumber(getDB("mplusDungeonSize", D.mplusDungeonSize)) or D.mplusDungeonSize)) end, set = function(v) setDB("mplusDungeonSize", clamp(v, "mplusDungeonSize")) end },
            { requires = "mythicPlus", type = "slider", name = L["FOCUS_TIMER_SIZE"], desc = L["FOCUS_FONT_SIZE_TIMER_PX"], dbKey = "mplusTimerSize", min = LIM.mplusTimerSize.min, max = LIM.mplusTimerSize.max, step = 1, get = function() return math.max(LIM.mplusTimerSize.min, math.min(LIM.mplusTimerSize.max, tonumber(getDB("mplusTimerSize", D.mplusTimerSize)) or D.mplusTimerSize)) end, set = function(v) setDB("mplusTimerSize", clamp(v, "mplusTimerSize")) end },
            { requires = "mythicPlus", type = "slider", name = L["FOCUS_SPLIT_TIMER_SIZE"], desc = L["FOCUS_FONT_SIZE_SPLIT_TIMER_PX"], dbKey = "mplusSplitSize", min = LIM.mplusSplitSize.min, max = LIM.mplusSplitSize.max, step = 1, get = function() return math.max(LIM.mplusSplitSize.min, math.min(LIM.mplusSplitSize.max, tonumber(getDB("mplusSplitSize", D.mplusSplitSize)) or D.mplusSplitSize)) end, set = function(v) setDB("mplusSplitSize", clamp(v, "mplusSplitSize")) end },
            { requires = "mythicPlus", type = "slider", name = L["ENEMY_FORCES_SIZE"], desc = L["FOCUS_FONT_SIZE_ENEMY_FORCES_PX"], dbKey = "mplusProgressSize", min = LIM.mplusProgressSize.min, max = LIM.mplusProgressSize.max, step = 1, get = function() return math.max(LIM.mplusProgressSize.min, math.min(LIM.mplusProgressSize.max, tonumber(getDB("mplusProgressSize", D.mplusProgressSize)) or D.mplusProgressSize)) end, set = function(v) setDB("mplusProgressSize", clamp(v, "mplusProgressSize")) end },
            { requires = "mythicPlus", type = "slider", name = L["FOCUS_AFFIX_SIZE"], desc = L["FOCUS_FONT_SIZE_AFFIXES_PX"], dbKey = "mplusAffixSize", min = LIM.mplusAffixSize.min, max = LIM.mplusAffixSize.max, step = 1, get = function() return math.max(LIM.mplusAffixSize.min, math.min(LIM.mplusAffixSize.max, tonumber(getDB("mplusAffixSize", D.mplusAffixSize)) or D.mplusAffixSize)) end, set = function(v) setDB("mplusAffixSize", clamp(v, "mplusAffixSize")) end },
            { requires = "mythicPlus", type = "slider", name = L["FOCUS_BOSS_SIZE"], desc = L["FOCUS_FONT_SIZE_BOSS_NAMES_PX"], dbKey = "mplusBossSize", min = LIM.mplusBossSize.min, max = LIM.mplusBossSize.max, step = 1, get = function() return math.max(LIM.mplusBossSize.min, math.min(LIM.mplusBossSize.max, tonumber(getDB("mplusBossSize", D.mplusBossSize)) or D.mplusBossSize)) end, set = function(v) setDB("mplusBossSize", clamp(v, "mplusBossSize")) end },
            Section(L["MYTHIC_COLOURS"], { requires = "mythicPlus", defaultCollapsed = true }),
            { requires = "mythicPlus", type = "color", name = L["FOCUS_DUNGEON_NAME_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_DUNGEON_NAME"], dbKey = "mplusDungeonColor", get = function() return getDB("mplusDungeonColorR", D.mplusDungeonColorR), getDB("mplusDungeonColorG", D.mplusDungeonColorG), getDB("mplusDungeonColorB", D.mplusDungeonColorB) end, set = function(r, g, b) setDB("mplusDungeonColorR", r); setDB("mplusDungeonColorG", g); setDB("mplusDungeonColorB", b) end },
            { requires = "mythicPlus", type = "color", name = L["FOCUS_TIMER_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_TIMER"], dbKey = "mplusTimerColor", get = function() return getDB("mplusTimerColorR", D.mplusTimerColorR), getDB("mplusTimerColorG", D.mplusTimerColorG), getDB("mplusTimerColorB", D.mplusTimerColorB) end, set = function(r, g, b) setDB("mplusTimerColorR", r); setDB("mplusTimerColorG", g); setDB("mplusTimerColorB", b) end },
            { requires = "mythicPlus", type = "color", name = L["FOCUS_TIMER_OVERTIME_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_TIMER_LIMIT"], dbKey = "mplusTimerOvertimeColor", get = function() return getDB("mplusTimerOvertimeColorR", D.mplusTimerOvertimeColorR), getDB("mplusTimerOvertimeColorG", D.mplusTimerOvertimeColorG), getDB("mplusTimerOvertimeColorB", D.mplusTimerOvertimeColorB) end, set = function(r, g, b) setDB("mplusTimerOvertimeColorR", r); setDB("mplusTimerOvertimeColorG", g); setDB("mplusTimerOvertimeColorB", b) end },
            { requires = "mythicPlus", type = "color", name = L["FOCUS_SPLIT_TIMER_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_SPLIT_TIMER"], dbKey = "mplusSplitColor", get = function() return getDB("mplusSplitColorR", D.mplusSplitColorR), getDB("mplusSplitColorG", D.mplusSplitColorG), getDB("mplusSplitColorB", D.mplusSplitColorB) end, set = function(r, g, b) setDB("mplusSplitColorR", r); setDB("mplusSplitColorG", g); setDB("mplusSplitColorB", b) end },
            { requires = "mythicPlus", type = "color", name = L["FOCUS_SPLIT_TIMER_PAST_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_SPLIT_TIMER_PAST"], dbKey = "mplusSplitPastColor", get = function() return getDB("mplusSplitPastColorR", D.mplusSplitPastColorR), getDB("mplusSplitPastColorG", D.mplusSplitPastColorG), getDB("mplusSplitPastColorB", D.mplusSplitPastColorB) end, set = function(r, g, b) setDB("mplusSplitPastColorR", r); setDB("mplusSplitPastColorG", g); setDB("mplusSplitPastColorB", b) end },
            { requires = "mythicPlus", type = "color", name = L["ENEMY_FORCES_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_ENEMY_FORCES"], dbKey = "mplusProgressColor", get = function() return getDB("mplusProgressColorR", D.mplusProgressColorR), getDB("mplusProgressColorG", D.mplusProgressColorG), getDB("mplusProgressColorB", D.mplusProgressColorB) end, set = function(r, g, b) setDB("mplusProgressColorR", r); setDB("mplusProgressColorG", g); setDB("mplusProgressColorB", b) end },
            { requires = "mythicPlus", type = "color", name = L["FOCUS_BAR_FILL_COLOUR"], desc = L["FOCUS_PROGRESS_BAR_FILL_COLOUR_PROGRESS"], dbKey = "mplusBarColor", get = function() return getDB("mplusBarColorR", D.mplusBarColorR), getDB("mplusBarColorG", D.mplusBarColorG), getDB("mplusBarColorB", D.mplusBarColorB), getDB("mplusBarColorA", D.mplusBarColorA) end, set = function(r, g, b, a) setDB("mplusBarColorR", r); setDB("mplusBarColorG", g); setDB("mplusBarColorB", b); if a then setDB("mplusBarColorA", a) end end, hasAlpha = true },
            { requires = "mythicPlus", type = "color", name = L["FOCUS_BAR_COMPLETE_COLOUR"], desc = L["FOCUS_PROGRESS_BAR_FILL_COLOUR_ENEMY_FORCES"], dbKey = "mplusBarDoneColor", get = function() return getDB("mplusBarDoneColorR", D.mplusBarDoneColorR), getDB("mplusBarDoneColorG", D.mplusBarDoneColorG), getDB("mplusBarDoneColorB", D.mplusBarDoneColorB), getDB("mplusBarDoneColorA", D.mplusBarDoneColorA) end, set = function(r, g, b, a) setDB("mplusBarDoneColorR", r); setDB("mplusBarDoneColorG", g); setDB("mplusBarDoneColorB", b); if a then setDB("mplusBarDoneColorA", a) end end, hasAlpha = true },
            { requires = "mythicPlus", type = "color", name = L["FOCUS_AFFIX_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_AFFIXES"], dbKey = "mplusAffixColor", get = function() return getDB("mplusAffixColorR", D.mplusAffixColorR), getDB("mplusAffixColorG", D.mplusAffixColorG), getDB("mplusAffixColorB", D.mplusAffixColorB) end, set = function(r, g, b) setDB("mplusAffixColorR", r); setDB("mplusAffixColorG", g); setDB("mplusAffixColorB", b) end },
            { requires = "mythicPlus", type = "color", name = L["FOCUS_BOSS_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_BOSS_NAMES"], dbKey = "mplusBossColor", get = function() return getDB("mplusBossColorR", D.mplusBossColorR), getDB("mplusBossColorG", D.mplusBossColorG), getDB("mplusBossColorB", D.mplusBossColorB) end, set = function(r, g, b) setDB("mplusBossColorR", r); setDB("mplusBossColorG", g); setDB("mplusBossColorB", b) end },
            ...
            { type = "toggle", name = L["ALWAYS"], desc = L["FOCUS_RUN_ALWAYS_DESC"], tooltip = L["FOCUS_RUN_ALWAYS_TOOLTIP"], dbKey = "runAlwaysShow", id = "runAlwaysShow", visibleWhen = function() return getDB("showRunBlock", D.showRunBlock) end, get = function() return getDB("runAlwaysShow", D.runAlwaysShow) end, set = function(v) setDB("runAlwaysShow", v); if addon.FullLayout then addon.FullLayout() end end },
            { type = "dropdown", name = L["BLOCK_POSITION"], desc = L["FOCUS_RUN_POSITION_DESC"], dbKey = "runBlockPosition", id = "runBlockPosition", visibleWhen = function() return getDB("showRunBlock", D.showRunBlock) end, options = MPLUS_POSITION_OPTIONS, get = function() return getDB("runBlockPosition", D.runBlockPosition) end, set = function(v) setDB("runBlockPosition", v); if addon.FullLayout then addon.FullLayout() end end },
            Section(L["FOCUS_RUN_TYPOGRAPHY"], { defaultCollapsed = true }),
            { type = "slider", name = L["FOCUS_DUNGEON_NAME_SIZE"], desc = L["FOCUS_FONT_SIZE_DUNGEON_NAME_PX"], dbKey = "runNameSize", min = LIM.runNameSize.min, max = LIM.runNameSize.max, step = 1, get = function() return math.max(LIM.runNameSize.min, math.min(LIM.runNameSize.max, tonumber(getDB("runNameSize", D.runNameSize)) or D.runNameSize)) end, set = function(v) setDB("runNameSize", clamp(v, "runNameSize")) end },
            { type = "slider", name = L["FOCUS_TIMER_SIZE"], desc = L["FOCUS_FONT_SIZE_TIMER_PX"], dbKey = "runTimerSize", min = LIM.runTimerSize.min, max = LIM.runTimerSize.max, step = 1, get = function() return math.max(LIM.runTimerSize.min, math.min(LIM.runTimerSize.max, tonumber(getDB("runTimerSize", D.runTimerSize)) or D.runTimerSize)) end, set = function(v) setDB("runTimerSize", clamp(v, "runTimerSize")) end },
            { type = "slider", name = L["FOCUS_RUN_STAT_SIZE"], desc = L["FOCUS_RUN_STAT_SIZE_DESC"], dbKey = "runStatSize", min = LIM.runStatSize.min, max = LIM.runStatSize.max, step = 1, get = function() return math.max(LIM.runStatSize.min, math.min(LIM.runStatSize.max, tonumber(getDB("runStatSize", D.runStatSize)) or D.runStatSize)) end, set = function(v) setDB("runStatSize", clamp(v, "runStatSize")) end },
            Section(L["FOCUS_RUN_COLOURS"], { defaultCollapsed = true }),
            { type = "color", name = L["FOCUS_DUNGEON_NAME_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_DUNGEON_NAME"], dbKey = "runNameColor", get = function() return getDB("runNameColorR", D.runNameColorR), getDB("runNameColorG", D.runNameColorG), getDB("runNameColorB", D.runNameColorB) end, set = function(r, g, b) setDB("runNameColorR", r); setDB("runNameColorG", g); setDB("runNameColorB", b) end },
            { type = "color", name = L["FOCUS_TIMER_COLOUR"], desc = L["FOCUS_TEXT_COLOUR_TIMER"], dbKey = "runTimerColor", get = function() return getDB("runTimerColorR", D.runTimerColorR), getDB("runTimerColorG", D.runTimerColorG), getDB("runTimerColorB", D.runTimerColorB) end, set = function(r, g, b) setDB("runTimerColorR", r); setDB("runTimerColorG", g); setDB("runTimerColorB", b) end },
            ...
            Button(L["FOCUS_RUN_RESET_STYLING"], nil, function()
                ...
                setDB("runStatSize", D.runStatSize)
                setDB("runNameColorR", D.runNameColorR); setDB("runNameColorG", D.runNameColorG); setDB("runNameColorB", D.runNameColorB)
                setDB("runTimerColorR", D.runTimerColorR); setDB("runTimerColorG", D.runTimerColorG); setDB("runTimerColorB", D.runTimerColorB)
                setDB("runLabelColorR", D.runLabelColorR); setDB("runLabelColorG", D.runLabelColorG); setDB("runLabelColorB", D.runLabelColorB)
                setDB("runValueColorR", D.runValueColorR); setDB("runValueColorG", D.runValueColorG); setDB("runValueColorB", D.runValueColorB)
                setDB("runRateColorR", D.runRateColorR); setDB("runRateColorG", D.runRateColorG); setDB("runRateColorB", D.runRateColorB)
            end, { refreshIds = { "runNameSize", "runTimerSize", "runStatSize", "runNameColor", "runTimerColor", "runLabelColor", "runValueColor", "runRateColor" } }),
    ...
    },
    {
        ...
        options = {
            ...
            Section(L["FOCUS_ENDEAVORS"], { requires = "housing" }),
            Toggle(L["FOCUS_SHOW_ENDEAVORS"], L["FOCUS_TRACKED_ENDEAVORS_PLAYER_HOUSING_LIST"], "showEndeavors", D.showEndeavors, { requires = "housing", refreshIds = { "showCompletedEndeavors" } }),
            Toggle(L["INCLUDE_COMPLETED"], L["FOCUS_INCLUDE_COMPLETED_ENDEAVORS_TRACKER"], "showCompletedEndeavors", D.showCompletedEndeavors, { requires = "housing", id = "showCompletedEndeavors", visibleWhen = function() return getDB("showEndeavors", D.showEndeavors) end }),
            Section(L["FOCUS_DECOR"], { requires = "housing" }),
            Toggle(L["FOCUS_SHOW_DECOR"], L["FOCUS_TRACKED_HOUSING_DECOR_LIST"], "showDecor", D.showDecor, { requires = "housing", refreshIds = { "showDecorIcons" } }),
            Toggle(L["DECOR_ICONS"], L["FOCUS_DECOR_ITEM_S_ICON_NEXT_TITLE"], "showDecorIcons", D.showDecorIcons, { requires = "housing", id = "showDecorIcons", visibleWhen = function() return getDB("showDecor", D.showDecor) end }),
            ...
            Section(L["FOCUS_ADVENTURE_GUIDE"], { requires = "adventureGuide" }),
            Toggle(L["TRAVELERS_LOG"], L["TRACKED_OBJECTIVES_ADVENTURE_GUIDE"], "showAdventureGuide", D.showAdventureGuide, { requires = "adventureGuide", refreshIds = { "autoRemoveCompletedAdventureGuide" } }),
            Toggle(L["UNTRACK_COMPLETE"], L["AUTO_UNTRACK_FINISHED_ACTIVITIES"], "autoRemoveCompletedAdventureGuide", D.autoRemoveCompletedAdventureGuide, { requires = "adventureGuide", id = "autoRemoveCompletedAdventureGuide", visibleWhen = function() return getDB("showAdventureGuide", D.showAdventureGuide) end }),
