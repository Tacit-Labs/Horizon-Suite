...
local categories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = L["FOCUS_PROXIMITY_AUTO_SUPERTRACK"], desc = L["FOCUS_PROXIMITY_AUTO_SUPERTRACK_DESC"], tooltip = L["FOCUS_PROXIMITY_AUTO_SUPERTRACK_TIP"], dbKey = "proximityAutoSuperTrack", isNew = "5.1.2", get = function() return getDB("proximityAutoSuperTrack", D.proximityAutoSuperTrack) end, set = function(v) setDB("proximityAutoSuperTrack", v); if addon.RequestRefresh then addon.RequestRefresh() end; if addon.FullLayout then addon.FullLayout() end end, refreshIds = { "proximityAutoIncludeUntracked" } },
            { type = "toggle", name = L["FOCUS_PROXIMITY_INCLUDE_UNTRACKED"], desc = L["FOCUS_PROXIMITY_INCLUDE_UNTRACKED_DESC"], tooltip = L["FOCUS_PROXIMITY_INCLUDE_UNTRACKED_TIP"], dbKey = "proximityAutoIncludeUntracked", isNew = "5.1.2", get = function() return getDB("proximityAutoIncludeUntracked", D.proximityAutoIncludeUntracked) end, set = function(v) setDB("proximityAutoIncludeUntracked", v); if addon.RequestRefresh then addon.RequestRefresh() end; if addon.FullLayout then addon.FullLayout() end end, visibleWhen = function() return getDB("proximityAutoSuperTrack", D.proximityAutoSuperTrack) end, id = "proximityAutoIncludeUntracked" },
