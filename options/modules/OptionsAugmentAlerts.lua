            ...
            right = {
                options = {
                    ...
                    { type = "dropdown",
                      ...
                      options = {
                          { L["AUGMENT_SOUND_CH_SFX"]      or "Sound Effects", "SFX"      },
                          { L["AUGMENT_SOUND_CH_MASTER"]   or "Master",        "Master"   },
                          { L["AUGMENT_SOUND_CH_DIALOG"]   or "Dialog",        "Dialog"   },
                          { L["AUGMENT_SOUND_CH_AMBIENCE"] or "Ambience",      "Ambience" },
                          { L["AUGMENT_SOUND_CH_MUSIC"]    or "Music",         "Music"    },
                      },
