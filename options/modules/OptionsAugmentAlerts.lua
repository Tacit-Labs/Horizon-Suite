        ...
        { type = "columns",
            left = {
                options = {
                    ...
                    { type = "slider",
                      name = L["AUGMENT_ICON_SIZE"], desc = L["AUGMENT_ICON_SIZE_DESC"],
                      dbKey = "alertsIconSize",
                      min = LIM.alertsIconSize.min, max = LIM.alertsIconSize.max, step = 1,
                      get = function() return math.max(LIM.alertsIconSize.min, math.min(LIM.alertsIconSize.max, tonumber(getDB("alertsIconSize", D.alertsIconSize)) or D.alertsIconSize)) end,
                      set = function(v) setDB("alertsIconSize", clamp(v, "alertsIconSize")); applyAlerts() end,
                    },
                    { type = "slider",
                      name = L["AUGMENT_ICON_GAP"], desc = L["AUGMENT_ICON_GAP_DESC"],
                      dbKey = "alertsIconGap",
                      min = LIM.alertsIconGap.min, max = LIM.alertsIconGap.max, step = 1,
                      get = function() return math.max(LIM.alertsIconGap.min, math.min(LIM.alertsIconGap.max, tonumber(getDB("alertsIconGap", D.alertsIconGap)) or D.alertsIconGap)) end,
                      set = function(v) setDB("alertsIconGap", clamp(v, "alertsIconGap")); applyAlerts() end,
                    },
                    { type = "dropdown",
                      name = L["AUGMENT_ALERTS_ICON_SIDE"], desc = L["AUGMENT_ALERTS_ICON_SIDE_DESC"],
                      dbKey = "alertsIconSide",
                      options = {
                          { L["AUGMENT_LAYOUT_LEFT"],  "left"  },
                          { L["AUGMENT_LAYOUT_RIGHT"], "right" },
                      },
                      get = function() return getDB("alertsIconSide", D.alertsIconSide) end,
                      set = function(v) setDB("alertsIconSide", v); applyAlerts() end,
                      preserveOrder = true,
                    },
                    { type = "dropdown",
                      name = L["AUGMENT_ALERTS_SLIDE_SIDE"], desc = L["AUGMENT_ALERTS_SLIDE_SIDE_DESC"],
                      dbKey = "alertsSlideSide",
                      options = {
                          { L["AUGMENT_LAYOUT_LEFT"],  "left"  },
                          { L["AUGMENT_LAYOUT_RIGHT"], "right" },
                      },
                      get = function() return getDB("alertsSlideSide", D.alertsSlideSide) end,
                      set = function(v) setDB("alertsSlideSide", v); applyAlerts() end,
                      preserveOrder = true,
                    },
                    { type = "dropdown",
                      name = L["AUGMENT_ALERTS_GROW_DIRECTION"], desc = L["AUGMENT_ALERTS_GROW_DIRECTION_DESC"],
                      dbKey = "alertsGrowDirection",
                      options = {
                          { L["AUGMENT_LAYOUT_UP"],   "up"   },
                          { L["AUGMENT_LAYOUT_DOWN"], "down" },
                      },
                      get = function() return getDB("alertsGrowDirection", D.alertsGrowDirection) end,
                      set = function(v) setDB("alertsGrowDirection", v); applyAlerts() end,
                      preserveOrder = true,
                    },
                    { type = "dropdown",
