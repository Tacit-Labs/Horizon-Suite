...
local categories = {
    {
        ...
        options = {
            ...
            Toggle(L["VISTA_TELEPORT_BUTTON"], L["VISTA_MINIMAP_TELEPORT_BUTTON"], "vistaShowTeleport", D.vistaShowTeleport, { refreshIds = { "vistaMouseoverTeleport" } }),
            Toggle(L["VISTA_TELEPORT_BUTTON_MOUSEOVER"], L["VISTA_HIDE_TELEPORT_BUTTON_UNTIL_YOU_HOVER"], "vistaMouseoverTeleport", D.vistaMouseoverTeleport, { disabled = function() return not getDB("vistaShowTeleport", D.vistaShowTeleport) end }),
            Section(L["VISTA_TELEPORT_MENU"]),
            Header(L["VISTA_CHOOSE_WHICH_TELEPORT_GROUPS_APPEAR"]),
            Toggle(L["VISTA_TELEPORT_GROUP_HEARTHSTONE"], L["VISTA_SHOW_HEARTHSTONE_TELEPORTS"], "vistaTeleportGroup_hearthstone", D.vistaTeleportGroup_hearthstone),
            Toggle(L["VISTA_TELEPORT_GROUP_PROFESSION"], L["VISTA_SHOW_PROFESSION_TELEPORTS"], "vistaTeleportGroup_profession", D.vistaTeleportGroup_profession),
            Toggle(L["VISTA_TELEPORT_GROUP_CLASS"], L["VISTA_SHOW_CLASS_TELEPORTS"], "vistaTeleportGroup_class", D.vistaTeleportGroup_class),
            Toggle(L["VISTA_TELEPORT_GROUP_DUNGEON"], L["VISTA_SHOW_DUNGEON_TELEPORTS"], "vistaTeleportGroup_dungeon", D.vistaTeleportGroup_dungeon),
            Toggle(L["VISTA_TELEPORT_GROUP_EVENT"], L["VISTA_SHOW_EVENT_TELEPORTS"], "vistaTeleportGroup_event", D.vistaTeleportGroup_event),
            Toggle(L["VISTA_TELEPORT_GROUP_OTHER"], L["VISTA_SHOW_OTHER_TELEPORTS"], "vistaTeleportGroup_other", D.vistaTeleportGroup_other),
    ...
    },
    {
        ...
        options = function()
            ...
            Toggle(L["VISTA_LOCK_TELEPORT_BUTTON"], L["VISTA_PREVENT_DRAGGING_TELEPORT_BUTTON"], "vistaLocked_proxy_teleport", D.vistaLocked_proxy_teleport),
            ...
            { type = "slider", name = L["VISTA_TELEPORT_BUTTON_SIZE"],
              desc = L["VISTA_SIZE_OF_TELEPORT_BUTTON_PIXELS"],
