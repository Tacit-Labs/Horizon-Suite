...
local categories = {
    {
        ...
        options = function()
            ...
            return {
                ...
                { type = "toggle", name = (BM and BM("flow") or L["NAME_ADDON_FLOW"]) .. previewSuffix, desc = L["DASH_FLOW_MODULE_SHORT_DESCRIPTION"] .. previewDescSuffix, dbKey = "_module_flow", get = function() return addon:IsModuleEnabled("flow") end, set = function(v) setModuleFromOptions("flow", v) end },
