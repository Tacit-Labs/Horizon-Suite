...
local VISTA_KEYS = {
    ...
    -- Proxy button positions (tracking + calendar + teleport + queue; landing page removed)
...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = L["VISTA_TELEPORT_BUTTON"] or "Show teleport button",
              desc = L["VISTA_MINIMAP_TELEPORT_BUTTON"] or "Show a button that lists toys, hearthstones and class teleports the character has unlocked.",
              dbKey = "vistaShowTeleport",
              get = function() return getDB("vistaShowTeleport", true) end,
              set = function(v) setDB("vistaShowTeleport", v) end,
              refreshIds = { "vistaMouseoverTeleport" } },
            { type = "toggle", name = L["VISTA_TELEPORT_BUTTON_MOUSEOVER"] or "Teleport button on mouseover only",
              desc = L["VISTA_HIDE_TELEPORT_BUTTON_UNTIL_YOU_HOVER"] or "Hide teleport button until you hover over the minimap.",
              dbKey = "vistaMouseoverTeleport",
              get = function() return getDB("vistaMouseoverTeleport", false) end,
              set = function(v) setDB("vistaMouseoverTeleport", v) end,
              disabled = function() return not getDB("vistaShowTeleport", true) end },
        },
    },
    {
        key = "VistaAppearance",
