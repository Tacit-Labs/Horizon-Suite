...
local OptionCategories = {
        ...
        options = function()
            ...
            opts[#opts + 1] = {
                ...
                options = {
                    ...
                    { L["OPTIONS_AXIS_CUSTOM_CLASS_ICONS_LABEL"] or "Custom", "custom" },
                },
    ...
    },
    {
        ...
        options = {
            ...
            { type = "dropdown", name = L["OPTIONS_AXIS_CLASS_ICON_STYLE"] or "Class icon style", desc = L["OPTIONS_AXIS_DEFAULT_BLIZZARD_RONDOMEDIA_CLASS_ICONS_TH"] or "Use Default (Blizzard) or RondoMedia class icons on the class/spec line.", tooltip = L["OPTIONS_AXIS_CLASS_ICON_SOURCES_TOOLTIP"], dbKey = "insightClassIconSource", options = { { L["OPTIONS_AXIS_DEFAULT"] or "Default", "default" }, { "RondoMedia", "rondomedia" }, { L["OPTIONS_AXIS_CUSTOM_CLASS_ICONS_LABEL"] or "Custom", "custom" } }, get = function() return getDB("insightClassIconSource", "default") end, set = function(v) setDB("insightClassIconSource", v) end, visibleWhen = function() return getDB("insightShowIcons", true) end },
