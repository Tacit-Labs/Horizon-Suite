...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "dropdown", name = L["VISTA_SHAPE"] or "Map shape",
              desc = L["VISTA_SHAPE_DESC"] or "Choose minimap shape: square, circle, or rectangle. Each shape has its own size.",
              dbKey = "vistaShape",
              ...
              get = function() return getDB("vistaShape", "square") end,
              set = function(v) setDB("vistaShape", v) end },
            { type = "slider", name = L["VISTA_SQUARE_SIZE"] or "Square size",
              desc = L["VISTA_WIDTH_HEIGHT_OF_MINIMAP_PIXELS"] or "Width and height of the minimap in pixels (100–400).",
              dbKey = "vistaSquareSize", min = 100, max = 400,
              get = function() return math.max(100, math.min(400, tonumber(getDB("vistaSquareSize", 200)) or 200)) end,
              set = function(v) setDB("vistaSquareSize", math.max(100, math.min(400, v))) end,
              disabled = function() return getDB("vistaShape", "square") ~= "square" end },
            { type = "slider", name = L["VISTA_CIRCLE_SIZE"] or "Circle size",
              desc = L["VISTA_WIDTH_HEIGHT_OF_MINIMAP_PIXELS"] or "Width and height of the minimap in pixels (100–400).",
              dbKey = "vistaCircleSize", min = 100, max = 400,
              get = function() return math.max(100, math.min(400, tonumber(getDB("vistaCircleSize", 200)) or 200)) end,
              set = function(v) setDB("vistaCircleSize", math.max(100, math.min(400, v))) end,
              disabled = function() return getDB("vistaShape", "square") ~= "circle" end },
            { type = "slider", name = L["VISTA_RECTANGLE_WIDTH"] or "Rectangle width",
              desc = L["VISTA_RECTANGLE_DESC"] or "Width and height of the rectangle minimap in pixels (100–500).",
              dbKey = "vistaRectangleWidth", min = 100, max = 500,
              get = function() return math.max(100, math.min(500, tonumber(getDB("vistaRectangleWidth", 280)) or 280)) end,
              set = function(v) setDB("vistaRectangleWidth", math.max(100, math.min(500, v))) end,
              disabled = function() return getDB("vistaShape", "square") ~= "rectangle" end },
            { type = "slider", name = L["VISTA_RECTANGLE_HEIGHT"] or "Rectangle height",
              desc = L["VISTA_RECTANGLE_DESC"] or "Width and height of the rectangle minimap in pixels (100–500).",
              dbKey = "vistaRectangleHeight", min = 100, max = 500,
              get = function() return math.max(100, math.min(500, tonumber(getDB("vistaRectangleHeight", 180)) or 180)) end,
              set = function(v) setDB("vistaRectangleHeight", math.max(100, math.min(500, v))) end,
              disabled = function() return getDB("vistaShape", "square") ~= "rectangle" end },
            { type = "section", name = L["AXIS_POSITION"] or "Position" },
