...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = L["OPTIONS_FOCUS_GROW_UPWARD"], desc = L["OPTIONS_FOCUS_ANCHOR_BOTTOM_LIST_GROWS_UPWARD"], dbKey = "growUp", get = function() return getDB("growUp", false) end, set = function(v) setDB("growUp", v); if addon.focus and addon.focus.layout then addon.focus.layout.scrollOffset = 0; addon.focus.layout.scrollBottomOffset = 0 end; if addon.FullLayout then addon.FullLayout() end end, refreshIds = { "growUpHeaderMode" } },
    ...
    },
    {
        ...
        desc = L["OPTIONS_FOCUS_APPEARANCE_TAB_DESC"],
        moduleKey = "focus",
        options = {
            ...
            { type = "dropdown", name = L["OPTIONS_FOCUS_TEXT_ALIGNMENT"], desc = L["OPTIONS_FOCUS_TEXT_ALIGNMENT_DESC"], dbKey = "focusTextAlignment", options = { { L["OPTIONS_FOCUS_ALIGN_LEFT"], "left" }, { L["OPTIONS_FOCUS_ALIGN_RIGHT"], "right" } }, get = function() return addon.GetFocusTextAlignment() end, set = function(v) setDB("focusTextAlignment", (v == "right") and "right" or "left"); if addon.ApplyFocusHeaderAlignment then addon.ApplyFocusHeaderAlignment() end; if addon.FullLayout then addon.FullLayout() end end },
            ...
            { type = "toggle", name = L["OPTIONS_CORE_QUEST_TYPE_ICONS"], desc = L["OPTIONS_PRESENCE_QUEST_TYPE_ICON_FOCUS_TRACKER_QUEST"], dbKey = "showQuestTypeIcons", get = function() return getDB("showQuestTypeIcons", true) end, set = function(v) setDB("showQuestTypeIcons", v) end },
            { type = "slider", name = L["OPTIONS_FOCUS_QUEST_TYPE_ICON_SIZE"], desc = L["OPTIONS_FOCUS_QUEST_TYPE_ICON_SIZE_DESC"], dbKey = "focusIconSize", min = 10, max = 28, get = function() return getDB("focusIconSize", 16) end, set = function(v) setDB("focusIconSize", math.max(10, math.min(28, v))) end, visibleWhen = function() return getDB("showQuestTypeIcons", true) end },
    ...
    },
    {
        ...
        desc = L["OPTIONS_FOCUS_CLICK_OPTIONS_TAB_DESC"],
        moduleKey = "focus",
        options = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "dropdown", name = L["OPTIONS_FOCUS_HEADER_TEXT_CASE"], desc = L["OPTIONS_FOCUS_DISPLAY_CASE_HEADER"], dbKey = "headerTextCase", options = TEXT_CASE_OPTIONS, get = function() local v = getDB("headerTextCase", "upper"); return (v == "default") and "upper" or v end, set = function(v) setDB("headerTextCase", v) end },
    ...
    },
    {
        ...
        desc = L["OPTIONS_FOCUS_INTERACTIONS_TAB_DESC"],
        moduleKey = "focus",
        options = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = L["OPTIONS_FOCUS_ACHIEVEMENT_PROGRESS_BARS"], desc = L["OPTIONS_FOCUS_ACHIEVEMENT_PROGRESS_BARS_DESC"], dbKey = "showAchievementProgressBars", id = "showAchievementProgressBars", visibleWhen = function() return getDB("showAchievements", true) end, get = function() return getDB("showAchievementProgressBars", false) end, set = function(v) setDB("showAchievementProgressBars", v); OptionsData_NotifyMainAddon() end, tooltip = L["OPTIONS_FOCUS_ACHIEVEMENT_PROGRESS_BARS_TIP"] },
    ...
    },
    {
        ...
        options = {
            ...
            { type = "dropdown", name = L["OPTIONS_CORE_TOOLTIP_ANCHOR"] or "Tooltip anchor", desc = L["OPTIONS_AXIS_WHERE_TOOLTIPS_APPEAR_FOLLOW_CURSOR_FIXED"] or "Where tooltips appear: follow cursor or fixed position.", dbKey = "insightAnchorMode", options = { { L["OPTIONS_AXIS_CURSOR"] or "Cursor", "cursor" }, { L["OPTIONS_AXIS_FIXED"] or "Fixed", "fixed" } }, get = function() return getDB("insightAnchorMode", "cursor") end, set = function(v) setDB("insightAnchorMode", v) end, refreshIds = { "insightCursorSide", "insightCursorOffsetX", "insightCursorOffsetY" } },
            { type = "dropdown", name = L["OPTIONS_INSIGHT_CURSOR_SIDE"] or "Cursor side", desc = L["OPTIONS_INSIGHT_CURSOR_SIDE_DESC"] or "Which side of the cursor the tooltip appears on.", dbKey = "insightCursorSide", options = { { L["OPTIONS_INSIGHT_CURSOR_SIDE_CENTER"] or "Center", "center" }, { L["OPTIONS_INSIGHT_CURSOR_SIDE_LEFT"] or "Left", "left" }, { L["OPTIONS_INSIGHT_CURSOR_SIDE_RIGHT"] or "Right", "right" } }, get = function() return getDB("insightCursorSide", "center") end, set = function(v) setDB("insightCursorSide", v) end, visibleWhen = function() return getDB("insightAnchorMode", "cursor") == "cursor" end, refreshIds = { "insightCursorOffsetX", "insightCursorOffsetY" } },
            { type = "slider", name = L["OPTIONS_INSIGHT_CURSOR_OFFSET_X"] or "Cursor offset X", desc = L["OPTIONS_INSIGHT_CURSOR_OFFSET_X_DESC"] or "Horizontal pixel offset from the cursor anchor position.", dbKey = "insightCursorOffsetX", min = -100, max = 100, step = 5, get = function() return math.max(-100, math.min(100, math.floor(tonumber(getDB("insightCursorOffsetX", 0)) or 0))) end, set = function(v) setDB("insightCursorOffsetX", math.max(-100, math.min(100, v))) end, visibleWhen = function() return getDB("insightAnchorMode", "cursor") == "cursor" and getDB("insightCursorSide", "center") ~= "center" end },
