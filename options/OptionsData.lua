...
local PRESENCE_KEYS = {
    ...
    presenceSuppressAbundance        = true,
    presenceSuppressDelve            = true,
    ...
    },
    {
        ...
        options = (function()
            ...
            return {
                ...
                areaToggle(L["PRESENCE_ABUNDANCE"],          L["PRESENCE_ABUNDANCE_DESC"],                         "presenceSuppressAbundance"),
                areaToggle(L["PRESENCE_DELVE"],              L["PRESENCE_DELVE_DESC"],                             "presenceSuppressDelve"),
