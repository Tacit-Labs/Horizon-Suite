...
function addon.Dashboard_BuildMainFrame()
    ...
    local f = CreateFrame("Frame", "HorizonSuiteDashboard", UIParent, "BackdropTemplate")
            ...
            local moduleLabels = {
                ...
                echo = addon.Dashboard_BrandModule("echo"),
            ...
            local TILE_MODULE_LABEL_COLORS = {
                ...
                echo     = { 143/255, 163/255, 232/255 },  -- 8FA3E8
            }
            ...
            local SEARCH_MODULE_FILTER_GROUP_ORDER = { "axis", "focus", "insight", "essence", "echo", "presence", "vista", "augment" }
            ...
            local MODULE_LABELS = { ["axis"] = addon.Dashboard_BrandModule("axis") or "Axis", ["modules"] = L["MODULES"], ["focus"] = addon.Dashboard_BrandModule("focus"), ["presence"] = addon.Dashboard_BrandModule("presence"), ["insight"] = addon.Dashboard_BrandModule("insight"), ["augment"] = addon.Dashboard_BrandModule("augment"), ["vista"] = addon.Dashboard_BrandModule("vista"), ["essence"] = addon.Dashboard_BrandModule("essence"), ["echo"] = addon.Dashboard_BrandModule("echo"), ["meridian"] = addon.Dashboard_BrandModule("meridian") }
            ...
            local groupOrder = { "axis", "focus", "insight", "essence", "echo", "presence", "vista", "augment" }
            local sidebarRows = {}
            ...
            local MODULE_NAME_KEYS = { "axis", "focus", "presence", "vista", "insight", "augment", "essence", "echo", "meridian" }
