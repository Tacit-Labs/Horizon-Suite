...
function addon.DashboardHomeWelcome_Init(env)
    ...
    local reloadText = MakeText(reloadBanner, L["HOME_RELOAD_PROMPT"], 12, 0.90, 0.82, 0.55, "LEFT")
    ...
    local reloadBtnLbl = MakeText(reloadBtn, L["RELOAD_UI"], 11, 0.95, 0.88, 0.60, "CENTER")
    ...
    local function MakeToggleCard(parent, moduleKey)
        ...
        local previewTitleSuffix = " |cff228b22(" .. (L["PRESENCE_PREVIEW"]) .. ")|r"
        local previewDisclaimer = L["MODULE_PREVIEW_DISCLAIMER"]
