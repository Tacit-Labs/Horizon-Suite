...
-- =====================================================================
L["OPTIONS_FOCUS_GROUP"]                                              = "Fokus konfigurieren"
L["OPTIONS_FOCUS_PRESENCE"]                                           = "Benachrichtigungen konfigurieren"
L["OPTIONS_FOCUS_OTHER"]                                              = "Sonstiges"

-- =====================================================================
-- OptionsPanel.lua — Section headers
-- =====================================================================
L["OPTIONS_FOCUS_QUEST_TYPES"]                                        = "Questtypen"
...
-- =====================================================================
L["OPTIONS_FOCUS_READY_TURN_OVERRIDES_BASE_COLOURS"]                  = "Abgabereif überschreibt Basis-Farben"
L["OPTIONS_FOCUS_READY_TURN_COLOURS_QUESTS"]                          = "Abgabereife Quests verwenden ihre Farben in diesem Abschnitt."
L["OPTIONS_FOCUS_CURRENT_ZONE_OVERRIDES_BASE_COLOURS"]                = "Aktuelle Zone überschreibt Basis-Farben"
L["OPTIONS_FOCUS_CURRENT_ZONE_COLOURS_QUESTS_SEC"]                    = "Quests der aktuellen Zone verwenden ihre Farben in diesem Abschnitt."
L["OPTIONS_FOCUS_CURRENT_QUEST_OVERRIDES_BASE_COLOURS"]               = "Aktuelle Quest überschreibt Basis-Farben"
...
L["OPTIONS_FOCUS_RESET_QUEST_TYPES"]                                  = "Questtypen zurücksetzen"
...
-- =====================================================================
L["OPTIONS_FOCUS_SEARCH_SETTINGS"]                                    = "Einstellungen suchen..."
L["OPTIONS_FOCUS_SEARCH_FONTS"]                                       = "Schriften suchen..."

-- =====================================================================
-- OptionsPanel.lua — Resize handle tooltip
-- =====================================================================
L["OPTIONS_FOCUS_DRAG_RESIZE"]                                        = "Ziehen zum Ändern der Größe"
...
L["OPTIONS_FOCUS_FILTERING"]                                          = "Filter"
...
L["OPTIONS_FOCUS_WORLD_QUESTS"]                                       = "Weltquests"
...
L["OPTIONS_FOCUS_SCENARIO_DELVE"]                                     = "Szenario & Tiefe"
...
L["OPTIONS_FOCUS_DELVES_DUNGEONS"]                                    = "Tiefen & Dungeons"
...
L["OPTIONS_FOCUS_SCENARIO_BAR"]                                       = "Szenario-Leiste"
...
L["OPTIONS_AXIS_SELECT_PROFILE_CURRENTLY"]                            = "Aktuell verwendetes Profil auswählen."
L["OPTIONS_AXIS_GLOBAL_PROFILE_ACCOUNT_WIDE"]                         = "Globales Profil (accountweit) verwenden"
L["OPTIONS_AXIS_CHARACTERS_SAME_PROFILE"]                             = "Alle Charaktere verwenden dasselbe Profil."
L["OPTIONS_AXIS_ENABLE_PER_SPECIALIZATION_PROFILES"]                  = "Profile pro Spezialisierung aktivieren"
L["OPTIONS_AXIS_PICK_DIFFERENT_PROFILES_PER_SPEC"]                    = "Verschiedene Profile pro Spezialisierung wählen."
...
L["OPTIONS_AXIS_SELECT_A_PROFILE_EXPORT"]                             = "Profil zum Exportieren wählen."
L["OPTIONS_AXIS_EXPORT_STRING"]                                       = "Export-String"
L["OPTIONS_AXIS_COPY_PROFILE"]                                        = "Aus Profil kopieren"
L["OPTIONS_AXIS_SOURCE_PROFILE_COPYING"]                              = "Quellprofil zum Kopieren."
L["OPTIONS_AXIS_COPY_SELECTED"]                                       = "Aus Auswahl kopieren"
L["OPTIONS_AXIS_CREATE"]                                              = "Erstellen"
L["OPTIONS_AXIS_CREATE_PROFILE_DEFAULT_TEMPLATE"]                     = "Neues Profil aus Standard-Vorlage erstellen"
L["OPTIONS_AXIS_CREATES_A_PROFILE_DEFAULT_SETTINGS"]                  = "Erstellt ein neues Profil mit allen Standardeinstellungen."
L["OPTIONS_AXIS_CREATES_A_PROFILE_COPIED_SELECTED_SOURC"]             = "Erstellt ein neues Profil als Kopie des ausgewählten Quellprofils."
L["OPTIONS_AXIS_DELETE_PROFILE"]                                      = "Profil löschen"
L["OPTIONS_AXIS_SELECT_A_PROFILE_DELETE_CURRENT_DEFAULT"]             = "Profil zum Löschen wählen (aktuell und Standard nicht angezeigt)."
L["OPTIONS_AXIS_DELETE_SELECTED"]                                     = "Auswahl löschen"
L["OPTIONS_AXIS_DELETE_SELECTED_PROFILE"]                             = "Ausgewähltes Profil löschen"
...
L["OPTIONS_AXIS_PER_SPEC_PROFILES"]                                   = "Profile pro Spezialisierung"

-- =====================================================================
-- OptionsData.lua Modules
-- =====================================================================
L["OPTIONS_AXIS_ENABLE_FOCUS_MODULE"]                                 = "Fokus-Modul aktivieren"
L["OPTIONS_AXIS_OBJECTIVE_TRACKER_QUESTS_WORLD_QUESTS_R"]             = "Zielverfolger für Quests, Weltquests, Rare Bosse, Erfolge und Szenarien anzeigen."
L["OPTIONS_AXIS_ENABLE_PRESENCE_MODULE"]                              = "Präsenz-Modul aktivieren"
L["OPTIONS_AXIS_CINEMATIC_ZONE_TEXT_NOTIFICATIONS_ZONE_CHANGES"]      = "Filmische Zonentexte und Benachrichtigungen (Zonenwechsel, Levelaufstieg, Boss-Emotes, Erfolge, Quest-Updates)."
L["OPTIONS_AXIS_ENABLE_CACHE_MODULE"]                                 = "Ertrag-Modul aktivieren"
L["OPTIONS_AXIS_CINEMATIC_LOOT_NOTIFICATIONS_ITEMS_MONEY_CURRENCY"]   = "Filmische Beute-Benachrichtigungen (Items, Gold, Währung, Ruf)."
...
L["OPTIONS_AXIS_MINIMAP_ZONE_TIME_COLLECTOR"]                         = "Filmische quadratische Minikarte mit Zonentext, Koordinaten, Zeit und Button-Sammlung."
...
L["OPTIONS_AXIS_SCALE_SIZES_SPACINGS_FONTS_FACTOR"]                   = "Alle Größen, Abstände und Schriftarten mit diesem Faktor skalieren (50–200%). Ändert keine konfigurierten Werte."
...
L["OPTIONS_AXIS_OVERRIDES_GLOBAL_SCALE_INDIVIDUAL_SLIDERS_F"]         = "Globale Skalierung durch Einzelschieber für Focus, Presence, Vista usw. ersetzen."
L["OPTIONS_AXIS_DOESN_T_CHANGE_YOUR_CONFIGURED_VALUES"]               = "Ändert keine konfigurierten Werte, nur die effektive Anzeige-Skalierung."
L["OPTIONS_FOCUS_SCALE"]                                              = "Fokus-Skalierung"
L["OPTIONS_AXIS_SCALE_FOCUS_OBJECTIVE_TRACKER"]                       = "Skalierung des Fokus-Zielverfolgers (50–200%)."
L["OPTIONS_PRESENCE_SCALE"]                                           = "Präsenz-Skalierung"
L["OPTIONS_AXIS_SCALE_PRESENCE_CINEMATIC_TEXT"]                       = "Skalierung des filmischen Präsenz-Textes (50–200%)."
L["OPTIONS_VISTA_SCALE"]                                              = "Vista-Skalierung"
L["OPTIONS_AXIS_SCALE_VISTA_MINIMAP_MODULE"]                          = "Skalierung des Vista-Minimap-Moduls (50–200%)."
L["OPTIONS_INSIGHT_SCALE"]                                            = "Insight-Skalierung"
L["OPTIONS_AXIS_SCALE_INSIGHT_TOOLTIP_MODULE"]                        = "Skalierung des Insight-Tooltip-Moduls (50–200%)."
...
L["OPTIONS_AXIS_TOOLTIP_ANCHOR_MODE"]                                 = "Tooltip-Anker-Modus"
...
L["OPTIONS_AXIS_WHETHER_YOU_COLLECTED_APPEARANCE_OF_AN"]              = "Anzeigen ob Sie bereits die Erscheinung eines Items gesammelt haben."
...
L["OPTIONS_AXIS_ITEM_LEVEL"]                                          = "Itemlevel anzeigen"
L["OPTIONS_AXIS_PLAYER_S_EQUIPPED_ITEM_LEVEL_AFTER"]                  = "Itemlevel des Spielers nach Inspektion anzeigen."
L["OPTIONS_AXIS_HONOR_LEVEL"]                                         = "Ehren-Ebenen anzeigen"
L["OPTIONS_AXIS_PLAYER_S_PVP_HONOR_LEVEL_TOOLTIP"]                    = "PvP-Ehren-Ebene des Spielers im Tooltip anzeigen."
...
L["OPTIONS_AXIS_MOUNT_INFO"]                                          = "Reittier-Info anzeigen"
...
L["OPTIONS_FOCUS_PREVENT_DRAGGING_TRACKER"]                           = "Verschieben des Zielverfolgers verhindern."
L["OPTIONS_FOCUS_GROW_UPWARD"]                                        = "Nach oben wachsen"
L["OPTIONS_FOCUS_GROW_HEADER"]                                        = "Aufwärts-Header"
L["OPTIONS_FOCUS_GROWING_UPWARD_KEEP_HEADER_BOTTOM_TOP"]              = "Beim Aufwärtswachsen: Header unten lassen oder oben bis zum Einklappen."
L["OPTIONS_FOCUS_HEADER_BOTTOM"]                                      = "Header unten"
L["OPTIONS_FOCUS_HEADER_SLIDES_COLLAPSE"]                             = "Header gleitet beim Einklappen"
L["OPTIONS_FOCUS_ANCHOR_BOTTOM_LIST_GROWS_UPWARD"]                    = "Unten verankern, damit die Liste nach oben wächst."
L["OPTIONS_FOCUS_START_COLLAPSED"]                                    = "Eingeklappt starten"
L["OPTIONS_FOCUS_START_HEADER_SHOWN_UNTIL_YOU_EXPAND"]                = "Nur mit Kopfzeile starten bis zum Aufklappen."
L["OPTIONS_FOCUS_ALIGN_CONTENT_RIGHT"]                                = "Inhalt rechts ausrichten"
L["OPTIONS_FOCUS_RIGHT_ALIGN_QUEST_TITLES_OBJECTIVES_WITHIN"]         = "Questtitel und Ziele im Panel rechts ausrichten."
L["OPTIONS_FOCUS_PANEL_WIDTH"]                                        = "Panel-Breite"
L["OPTIONS_FOCUS_TRACKER_WIDTH_PIXELS"]                               = "Breite des Zielverfolgers in Pixeln."
L["OPTIONS_FOCUS_MAX_CONTENT_HEIGHT"]                                 = "Max. Inhaltshöhe"
L["OPTIONS_FOCUS_MAX_HEIGHT_OF_SCROLLABLE_LIST_PIXELS"]               = "Maximale Höhe der scrollbaren Liste (Pixel)."

-- =====================================================================
-- OptionsData.lua Visibility
-- =====================================================================
L["OPTIONS_FOCUS_ALWAYS_M_BLOCK"]                                     = "M+-Block immer anzeigen"
L["OPTIONS_FOCUS_M_BLOCK_WHENEVER_AN_ACTIVE_KEYSTONE"]                = "M+-Block anzeigen wenn aktiver Schlüsselstein läuft"
L["OPTIONS_FOCUS_DUNGEON"]                                            = "In Dungeon anzeigen"
L["OPTIONS_FOCUS_TRACKER_PARTY_DUNGEONS"]                             = "Zielverfolger in Gruppen-Dungeons anzeigen."
L["OPTIONS_FOCUS_RAID"]                                               = "In Schlachtzug anzeigen"
L["OPTIONS_FOCUS_TRACKER_RAIDS"]                                      = "Zielverfolger in Schlachtzügen anzeigen."
L["OPTIONS_FOCUS_BATTLEGROUND"]                                       = "In Schlachtfeld anzeigen"
L["OPTIONS_FOCUS_TRACKER_BATTLEGROUNDS"]                              = "Zielverfolger in Schlachtfeldern anzeigen."
L["OPTIONS_FOCUS_ARENA"]                                              = "In Arena anzeigen"
L["OPTIONS_FOCUS_TRACKER_ARENAS"]                                     = "Zielverfolger in Arenen anzeigen."
L["OPTIONS_FOCUS_HIDE_COMBAT"]                                        = "Im Kampf verbergen"
L["OPTIONS_FOCUS_HIDE_TRACKER_FLOATING_QUEST_ITEM_COMBAT"]            = "Zielverfolger und schwebendes Quest-Item im Kampf verbergen."
L["OPTIONS_FOCUS_COMBAT_VISIBILITY"]                                  = "Kampf-Sichtbarkeit"
L["OPTIONS_FOCUS_TRACKER_BEHAVES_COMBAT_FADE_REDUC"]                  = "Verhalten des Zielverfolgers im Kampf: anzeigen, abdunkeln oder verbergen."
L["OPTIONS_FOCUS_SHOW"]                                               = "Anzeigen"
L["OPTIONS_FOCUS_FADE"]                                               = "Verblassen"
L["OPTIONS_FOCUS_HIDE"]                                               = "Verbergen"
L["OPTIONS_FOCUS_COMBAT_FADE_OPACITY"]                                = "Kampf-Ausblend-Deckkraft"
L["OPTIONS_FOCUS_VISIBLE_TRACKER_FADED_COMBAT"]                       = "Sichtbarkeit ausgeblendet im Kampf (0 = unsichtbar). Nur bei Kampf-Sichtbarkeit „Ausblenden\"."
L["OPTIONS_FOCUS_MOUSEOVER"]                                          = "Mausüber"
L["OPTIONS_FOCUS_SHOW_ONLY_MOUSEOVER"]                                = "Nur bei Mausüber anzeigen"
L["OPTIONS_FOCUS_FADE_TRACKER_HOVERING_MOVE_MOUSE"]                   = "Zielverfolger ausblenden wenn nicht darüber; Maus darüber für Anzeige."
L["OPTIONS_FOCUS_FADED_OPACITY"]                                      = "Ausgeblendete Deckkraft"
L["OPTIONS_FOCUS_VISIBLE_TRACKER_FADED_INVISIBLE"]                    = "Sichtbarkeit des Zielverfolgers ausgeblendet (0 = unsichtbar)."
L["OPTIONS_FOCUS_QUESTS_CURRENT_ZONE"]                                = "Nur Quests in aktueller Zone anzeigen"
L["OPTIONS_FOCUS_HIDE_QUESTS_OUTSIDE_YOUR_CURRENT_ZONE"]              = "Quests außerhalb Ihrer Zone verbergen."

-- =====================================================================
-- OptionsData.lua Display — Header
-- =====================================================================
L["OPTIONS_FOCUS_QUEST_COUNT"]                                        = "Quest-Anzahl anzeigen"
L["OPTIONS_FOCUS_QUEST_COUNT_HEADER"]                                 = "Quest-Anzahl in Kopfzeile anzeigen."
L["OPTIONS_FOCUS_HEADER_COUNT_FORMAT"]                                = "Kopfzeilen-Zählformat"
...
L["OPTIONS_FOCUS_HEADER_DIVIDER"]                                     = "Kopfzeilen-Trennlinie anzeigen"
L["OPTIONS_FOCUS_LINE_BELOW_HEADER"]                                  = "Linie unter der Kopfzeile anzeigen."
L["OPTIONS_FOCUS_HEADER_DIVIDER_COLOR"]                               = "Kopfzeilen-Trennlinien-Farbe"
...
L["OPTIONS_FOCUS_HIDE_HEADER_A_PURE_TEXT_LIST"]                       = "Kopfzeile für reine Textliste verbergen."
L["OPTIONS_FOCUS_OPTIONS_BUTTON"]                                     = "Optionen-Button anzeigen"
L["OPTIONS_FOCUS_OPTIONS_BUTTON_TRACKER_HEADER"]                      = "Optionen-Button in der Zielverfolger-Kopfzeile anzeigen."
L["OPTIONS_FOCUS_HEADER_COLOR"]                                       = "Kopfzeilen-Farbe"
L["OPTIONS_FOCUS_COLOR_OF_OBJECTIVES_HEADER_TEXT"]                    = "Farbe des ZIELE-Header-Texts."
L["OPTIONS_FOCUS_HEADER_HEIGHT"]                                      = "Kopfzeilen-Höhe"
L["OPTIONS_FOCUS_HEIGHT_OF_HEADER_BAR_PIXELS"]                        = "Höhe der Kopfzeilen-Leiste in Pixeln (18–48)."

-- =====================================================================
-- OptionsData.lua Display — List
-- =====================================================================
L["OPTIONS_FOCUS_SECTION_HEADERS"]                                    = "Abschnitts-Header anzeigen"
L["OPTIONS_FOCUS_CATEGORY_LABELS_ABOVE_GROUP"]                        = "Kategorie-Labels über jeder Gruppe anzeigen."
L["OPTIONS_FOCUS_CATEGORY_HEADERS_COLLAPSED"]                         = "Kategorie-Header eingeklappt anzeigen"
L["OPTIONS_FOCUS_KEEP_SECTION_HEADERS_VISIBLE_COLLAPSED_CLICK"]       = "Abschnittsüberschriften eingeklappt sichtbar lassen; klicken zum Erweitern."
L["OPTIONS_FOCUS_NEARBY_CURRENT_ZONE_GROUP"]                          = "Nah (Aktuelle Zone) Gruppe anzeigen"
L["OPTIONS_FOCUS_ZONE_QUESTS_A_DEDICATED_CURRENT_ZONE"]               = "Zonen-Quests in eigenem Aktuelle-Zone-Abschnitt. Aus: normale Kategorie."
L["OPTIONS_FOCUS_ZONE_LABELS"]                                        = "Zonen-Labels anzeigen"
L["OPTIONS_FOCUS_ZONE_NAME_UNDER_QUEST_TITLE"]                        = "Zonennamen unter jedem Quest-Titel anzeigen."
L["OPTIONS_FOCUS_ACTIVE_QUEST_HIGHLIGHT"]                             = "Aktive Quest hervorheben"
L["OPTIONS_FOCUS_FOCUSED_QUEST_HIGHLIGHTED"]                          = "Wie die fokussierte Quest hervorgehoben wird."
L["OPTIONS_FOCUS_QUEST_ITEM_BUTTONS"]                                 = "Quest-Item-Buttons anzeigen"
L["OPTIONS_FOCUS_USABLE_QUEST_ITEM_BUTTON_NEXT_QUEST"]                = "Nutzbares Quest-Item-Button neben jeder Quest anzeigen."
...
L["OPTIONS_FOCUS_OBJECTIVE_NUMBERS"]                                  = "Zielnummern anzeigen"
L["OPTIONS_FOCUS_OBJECTIVE_PREFIX"]                                   = "Ziel-Präfix"
L["OPTIONS_FOCUS_PREFIX_OBJECTIVE_A_NUMBER_HYPHEN"]                   = "Jedes Ziel mit Nummer oder Bindestrich versehen."
L["OPTIONS_FOCUS_NUMBERS"]                                            = "Zahlen (1. 2. 3.)"
L["OPTIONS_FOCUS_HYPHENS"]                                            = "Bindestriche (-)"
L["OPTIONS_FOCUS_AFTER_SECTION_HEADER"]                               = "Nach Abschnittsüberschrift"
L["OPTIONS_FOCUS_BEFORE_SECTION_HEADER"]                              = "Vor Abschnittsüberschrift"
L["OPTIONS_FOCUS_BELOW_HEADER"]                                       = "Unter Kopfzeile"
L["OPTIONS_FOCUS_INLINE_BELOW_TITLE"]                                 = "Inline unter Titel"
L["OPTIONS_FOCUS_PREFIX_OBJECTIVES"]                                  = "Ziele mit 1., 2., 3. versehen."
L["OPTIONS_FOCUS_COMPLETED_COUNT"]                                    = "Abgeschlossene-Anzahl anzeigen"
L["OPTIONS_FOCUS_X_Y_PROGRESS_QUEST_TITLE"]                           = "X/Y-Fortschritt im Quest-Titel anzeigen."
L["OPTIONS_FOCUS_OBJECTIVE_PROGRESS_BAR"]                             = "Ziel-Fortschrittsbalken anzeigen"
L["OPTIONS_FOCUS_A_PROGRESS_BAR_UNDER_OBJECTIVES_NUMER"]              = "Fortschrittsbalken unter Zielen mit numerischem Fortschritt (z.B. 3/250). Nur bei Einträgen mit einem arithmetischen Ziel > 1."
L["OPTIONS_FOCUS_CATEGORY_COLOR_PROGRESS_BAR"]                        = "Kategoriefarbe für Fortschrittsbalken verwenden"
L["OPTIONS_FOCUS_PROGRESS_BAR_MATCHES_QUEST_ACHIEVEME"]               = "An: Fortschrittsbalken nutzt Kategoriefarbe. Aus: benutzerdefinierte Füllfarbe unten."
L["OPTIONS_FOCUS_PROGRESS_BAR_TEXTURE"]                               = "Fortschrittsbalken-Textur"
L["OPTIONS_FOCUS_PROGRESS_BAR_TYPES"]                                 = "Fortschrittsbalken-Typen"
L["OPTIONS_FOCUS_TEXTURE_PROGRESS_BAR_FILL"]                          = "Textur für die Fortschrittsbalken-Füllung."
L["OPTIONS_FOCUS_TEXTURE_PROGRESS_BAR_FILL_SOLID_YOUR"]               = "Textur für Fortschrittsbalken-Füllung. Solid nutzt Ihre Farben. SharedMedia-Addons bieten mehr Optionen."
L["OPTIONS_FOCUS_PROGRESS_BAR_X_Y_OBJECTIVES_PERCENT"]                = "Fortschrittsleiste für X/Y-Ziele, nur-Prozent-Ziele oder beides anzeigen."
...
L["OPTIONS_FOCUS_TICK_COMPLETED_OBJECTIVES"]                          = "Häkchen für abgeschlossene Ziele verwenden"
L["OPTIONS_FOCUS_COMPLETED_OBJECTIVES_A_CHECKMARK_INSTEA"]            = "An: abgeschlossene Ziele zeigen Häkchen (✓) statt grüner Farbe."
L["OPTIONS_FOCUS_ENTRY_NUMBERS"]                                      = "Eintragsnummern anzeigen"
L["OPTIONS_FOCUS_PREFIX_QUEST_TITLES_WITHIN_CATEGORY"]                = "Quest-Titel mit 1., 2., 3. versehen."
L["OPTIONS_FOCUS_COMPLETED_OBJECTIVES"]                               = "Abgeschlossene Ziele"
L["OPTIONS_FOCUS_MULTI_OBJECTIVE_QUESTS_DISPLAY_OBJECTIVES"]          = "Für Multi-Ziel-Quests: Darstellung abgeschlossener Ziele (z.B. 1/1)."
L["OPTIONS_FOCUS_ALL"]                                                = "Alle anzeigen"
L["OPTIONS_FOCUS_FADE_COMPLETED"]                                     = "Abgeschlossene ausblenden"
L["OPTIONS_FOCUS_HIDE_COMPLETED"]                                     = "Abgeschlossene verbergen"
L["OPTIONS_FOCUS_ICON_ZONE_AUTO_TRACKING"]                            = "Symbol für automatische Zonen-Verfolgung anzeigen"
L["OPTIONS_FOCUS_DISPLAY_AN_ICON_NEXT_AUTO_TRACKED"]                  = "Symbol bei automatisch verfolgten Weltquests und Wochen-/Tagesquests anzeigen, die noch nicht im Questlog sind (nur in Zone)."
L["OPTIONS_FOCUS_AUTO_TRACK_ICON"]                                    = "Auto-Track-Symbol"
L["OPTIONS_FOCUS_CHOOSE_WHICH_ICON_DISPLAY_NEXT_AUTO"]                = "Symbol für automatisch verfolgte Zoneneinträge wählen."
L["OPTIONS_FOCUS_APPEND_WORLD_QUESTS_WEEKLIES_DAILIES"]               = "** an Weltquests und Wochen-/Tagesquests anhängen, die noch nicht im Questlog sind (nur in Zone)."
...
L["OPTIONS_FOCUS_COMPACT_VERSION"]                                    = "Kompakte Version"
L["OPTIONS_FOCUS_SPACED_VERSION"]                                     = "Abstands-Version"
...
-- =====================================================================
L["OPTIONS_FOCUS_ZONE_WORLD_QUESTS"]                                  = "Weltquests in Zone anzeigen"
L["OPTIONS_FOCUS_AUTO_ADD_WORLD_QUESTS_YOUR_CURRENT"]                 = "Weltquests in Ihrer Zone automatisch hinzufügen. Aus: nur getrackte Quests oder nahe Weltquests (Blizzard-Standard)."
...
L["OPTIONS_FOCUS_COMPLETED_ACHIEVEMENTS"]                             = "Abgeschlossene Erfolge anzeigen"
L["OPTIONS_FOCUS_INCLUDE_COMPLETED_ACHIEVEMENTS_TRACKER_O"]           = "Abgeschlossene Erfolge im Zielverfolger anzeigen. Aus: nur verfolgte in Bearbeitung."
L["OPTIONS_FOCUS_ACHIEVEMENT_ICONS"]                                  = "Erfolgs-Symbole anzeigen"
L["OPTIONS_FOCUS_ACHIEVEMENT_S_ICON_NEXT_TITLE_REQUI"]                = "Erfolgs-Symbol neben Titel anzeigen. Erfordert „Quest-Typ-Symbole anzeigen\" in Anzeige."
L["OPTIONS_FOCUS_MISSING_REQUIREMENTS"]                               = "Nur fehlende Anforderungen anzeigen"
...
L["OPTIONS_FOCUS_TRACKED_ENDEAVORS_PLAYER_HOUSING_LIST"]              = "Verfolgte Bestrebungen (Spielerwohnung) in der Liste anzeigen."
...
L["OPTIONS_FOCUS_TRACKED_HOUSING_DECOR_LIST"]                         = "Verfolgte Wohnungs-Dekoration in der Liste anzeigen."
L["OPTIONS_FOCUS_DECOR_ICONS"]                                        = "Dekorations-Symbole anzeigen"
L["OPTIONS_FOCUS_DECOR_ITEM_S_ICON_NEXT_TITLE"]                       = "Dekorations-Symbol neben Titel anzeigen. Erfordert „Quest-Typ-Symbole anzeigen\" in Anzeige."

-- =====================================================================
-- OptionsData.lua Features — Adventure Guide
-- =====================================================================
L["OPTIONS_FOCUS_ADVENTURE_GUIDE"]                                    = "Abenteuerführer"
L["OPTIONS_FOCUS_TRAVELER_S_LOG"]                                     = "Reisenden-Log anzeigen"
L["OPTIONS_FOCUS_TRACKED_TRAVELER_S_LOG_OBJECTIVES_SHIFT"]            = "Verfolgte Reisenden-Log-Ziele (Umschalt+Klick im Abenteuerführer) in der Liste anzeigen."
L["OPTIONS_FOCUS_AUTO_REMOVE_COMPLETED_ACTIVITIES"]                   = "Abgeschlossene Aktivitäten automatisch entfernen"
L["OPTIONS_FOCUS_AUTOMATICALLY_STOP_TRACKING_TRAVELER_S_LOG"]         = "Reisenden-Log-Aktivitäten nach Abschluss automatisch nicht mehr verfolgen."

-- =====================================================================
-- OptionsData.lua Features — Scenario & Delve
-- =====================================================================
L["OPTIONS_FOCUS_SCENARIO_EVENTS"]                                    = "Szenario-Ereignisse anzeigen"
...
L["OPTIONS_FOCUS_DELVE_DUNGEON"]                                      = "Nur Tiefe/Dungeon"
...
L["OPTIONS_FOCUS_WHERE_COUNTDOWN_BAR_BELOW_OBJECTIVES"]               = "Wo der Countdown angezeigt wird: Leiste unter Zielen oder Text neben dem Questnamen."
...
L["OPTIONS_FOCUS_TITLE_FONT"]                                         = "Titel-Schriftart"
L["OPTIONS_VISTA_ZONE_FONT"]                                          = "Zonen-Schriftart"
L["OPTIONS_FOCUS_OBJECTIVE_FONT"]                                     = "Ziel-Schriftart"
L["OPTIONS_FOCUS_SECTION_FONT"]                                       = "Abschnitts-Schriftart"
...
L["OPTIONS_FOCUS_FONT_FAMILY_ZONE_LABELS"]                            = "Schriftart für Zonen-Labels."
...
L["OPTIONS_FOCUS_HEADER_SIZE"]                                        = "Kopfzeilen-Größe"
L["OPTIONS_FOCUS_HEADER_FONT_SIZE"]                                   = "Kopfzeilen-Schriftgröße."
L["OPTIONS_FOCUS_TITLE_SIZE"]                                         = "Titel-Größe"
L["OPTIONS_FOCUS_QUEST_TITLE_FONT_SIZE"]                              = "Quest-Titel-Schriftgröße."
L["OPTIONS_FOCUS_OBJECTIVE_SIZE"]                                     = "Ziel-Größe"
L["OPTIONS_FOCUS_OBJECTIVE_TEXT_FONT_SIZE"]                           = "Zieltext-Schriftgröße."
L["OPTIONS_FOCUS_ZONE_SIZE"]                                          = "Zonen-Größe"
L["OPTIONS_FOCUS_ZONE_LABEL_FONT_SIZE"]                               = "Zonen-Label-Schriftgröße."
L["OPTIONS_FOCUS_SECTION_SIZE"]                                       = "Abschnitts-Größe"
L["OPTIONS_FOCUS_SECTION_HEADER_FONT_SIZE"]                           = "Abschnitts-Header-Schriftgröße."
L["OPTIONS_FOCUS_PROGRESS_BAR_FONT"]                                  = "Fortschrittsbalken-Schriftart"
L["OPTIONS_FOCUS_FONT_FAMILY_PROGRESS_BAR_LABEL"]                     = "Schriftart für die Fortschrittsbalken-Beschriftung."
L["OPTIONS_FOCUS_PROGRESS_BAR_TEXT_SIZE"]                             = "Fortschrittsbalken-Textgröße"
L["OPTIONS_FOCUS_FONT_SIZE_PROGRESS_BAR_LABEL_ADJUSTS"]               = "Schriftgröße für Fortschrittsbalken-Beschriftung. Beeinflusst auch Balkenhöhe. Gilt für Quest-Ziele, Szenario-Fortschritt und Timer-Balken."
L["OPTIONS_FOCUS_PROGRESS_BAR_FILL"]                                  = "Fortschrittsbalken-Füllung"
L["OPTIONS_FOCUS_PROGRESS_BAR_TEXT"]                                  = "Fortschrittsbalken-Text"
L["OPTIONS_FOCUS_OUTLINE"]                                            = "Umriss"
L["OPTIONS_FOCUS_FONT_OUTLINE_STYLE"]                                 = "Schriftart-Umriss-Stil."
...
-- =====================================================================
L["OPTIONS_FOCUS_TEXT_SHADOW"]                                        = "Text-Schatten anzeigen"
L["OPTIONS_FOCUS_ENABLE_DROP_SHADOW_TEXT"]                            = "Schattierung für Text aktivieren."
L["OPTIONS_FOCUS_SHADOW_X"]                                           = "Schatten X"
L["OPTIONS_FOCUS_HORIZONTAL_SHADOW_OFFSET"]                           = "Horizontaler Schatten-Offset."
L["OPTIONS_FOCUS_SHADOW_Y"]                                           = "Schatten Y"
L["OPTIONS_FOCUS_VERTICAL_SHADOW_OFFSET"]                             = "Vertikaler Schatten-Offset."
L["OPTIONS_FOCUS_SHADOW_ALPHA"]                                       = "Schatten-Alpha"
L["OPTIONS_FOCUS_SHADOW_OPACITY"]                                     = "Schatten-Deckkraft (0–1)."

-- =====================================================================
-- OptionsData.lua Typography — Mythic+ Typography
-- =====================================================================
L["OPTIONS_FOCUS_MYTHIC_TYPOGRAPHY"]                                  = "Mythisch+-Typografie"
L["OPTIONS_FOCUS_DUNGEON_NAME_SIZE"]                                  = "Dungeon-Namen-Größe"
L["OPTIONS_FOCUS_FONT_SIZE_DUNGEON_NAME_PX"]                          = "Schriftgröße für Dungeon-Namen (8–32 px)."
L["OPTIONS_FOCUS_DUNGEON_NAME_COLOR"]                                 = "Dungeon-Namen-Farbe"
...
L["OPTIONS_FOCUS_PROGRESS_SIZE"]                                      = "Fortschritts-Größe"
L["OPTIONS_FOCUS_FONT_SIZE_ENEMY_FORCES_PX"]                          = "Schriftgröße für feindliche Streitkräfte (8–32 px)."
L["OPTIONS_FOCUS_PROGRESS_COLOR"]                                     = "Fortschritts-Farbe"
L["OPTIONS_FOCUS_TEXT_COLOR_ENEMY_FORCES"]                            = "Textfarbe für feindliche Streitkräfte."
L["OPTIONS_FOCUS_BAR_FILL_COLOR"]                                     = "Leisten-Füllfarbe"
L["OPTIONS_FOCUS_PROGRESS_BAR_FILL_COLOR_PROGRESS"]                   = "Fortschrittsbalken-Füllfarbe (in Bearbeitung)."
L["OPTIONS_FOCUS_BAR_COMPLETE_COLOR"]                                 = "Leisten-Farbe (abgeschlossen)"
L["OPTIONS_FOCUS_PROGRESS_BAR_FILL_COLOR_ENEMY_FORCES"]               = "Fortschrittsbalken-Füllfarbe bei 100% feindlicher Streitkräfte."
...
L["OPTIONS_FOCUS_PANEL_BACKGROUND_OPACITY"]                           = "Panel-Hintergrund-Deckkraft (0–1)."
...
L["OPTIONS_FOCUS_WIDTH_OF_BAR_STYLE_HIGHLIGHTS_PX"]                   = "Breite der Leisten-Hervorhebung (2–6 px)."
...
L["OPTIONS_FOCUS_CATEGORY_ORDER"]                                     = "Fokus-Kategorie-Reihenfolge"
...
L["OPTIONS_FOCUS_SECONDS_OF_RECENT_PROGRESS_CURRENT_QUEST"]           = "Sekunden Fortschritt für Aktuelle Quest (30–120)."
...
L["OPTIONS_FOCUS_SORT_MODE"]                                          = "Fokus-Sortiermodus"
...
L["OPTIONS_FOCUS_YOU_MUST_A_PARTY_SHARE_QUEST"]                       = "Sie müssen in einer Gruppe sein, um diese Quest zu teilen."
L["OPTIONS_FOCUS_LEFT_CLICK_OPENS_QUEST_MAP_RIGHT"]                   = "An: Linksklick öffnet Questkarte, Rechtsklick Teilen/Abbruch (Blizzard). Aus: Linksklick fokussiert, Rechtsklick nicht verfolgen; Strg+Rechts teilt."
...
L["OPTIONS_FOCUS_OBJECTIVE_PROGRESS_FLASH"]                           = "Ziel-Fortschritt-Blitz"
L["OPTIONS_FOCUS_FLASH_AN_OBJECTIVE_COMPLETES"]                       = "Blitz bei Ziel-Abschluss anzeigen."
L["OPTIONS_FOCUS_FLASH_INTENSITY"]                                    = "Blitz-Intensität"
L["OPTIONS_FOCUS_NOTICEABLE_OBJECTIVE_COMPLETE_FLASH"]                = "Wie auffällig der Ziel-Abschluss-Blitz ist."
L["OPTIONS_FOCUS_FLASH_COLOR"]                                        = "Blitz-Farbe"
L["OPTIONS_FOCUS_COLOR_OF_OBJECTIVE_COMPLETE_FLASH"]                  = "Farbe des Ziel-Abschluss-Blitzes."
...
L["OPTIONS_FOCUS_REQUIRES_CTRL_LEFT_CLICK_COMPLETE_AUTO"]             = "An: Strg+Linksklick für Klick-Abschluss. Aus: einfacher Linksklick (Blizzard-Standard). Nur bei klickbaren Quests."
L["OPTIONS_FOCUS_SUPPRESS_UNTRACKED_UNTIL_RELOAD"]                    = "Nicht verfolgte bis Neuladen unterdrücken"
L["OPTIONS_FOCUS_RIGHT_CLICK_UNTRACK_WORLD_QUESTS_Z"]                 = "An: Rechtsklick Nicht verfolgen versteckt bis Neuladen oder neuer Sitzung. Aus: erscheinen wieder bei Zonen-Rückkehr."
...
L["OPTIONS_FOCUS_CAMPAIGN_QUESTS_READY_TURN_RE"]                      = "An: abgabereife Kampagnen-Quests bleiben in Kampagne statt in Abgeschlossen."
L["OPTIONS_FOCUS_KEEP_IMPORTANT_QUESTS_CATEGORY"]                     = "Wichtige Quests in Kategorie bleiben"
L["OPTIONS_FOCUS_IMPORTANT_QUESTS_READY_TURN_R"]                      = "An: abgabereife wichtige Quests bleiben in Wichtig statt in Abgeschlossen."
...
L["OPTIONS_FOCUS_TOMTOM_RARE_WAYPOINT"]                               = "TomTom-Selten-Boss-Wegpunkt"
...
L["OPTIONS_FOCUS_DUAL_EDGE_BARS"]                                     = "Doppelrand-Leisten"
L["OPTIONS_FOCUS_PILL_LEFT_ACCENT"]                                   = "Pill-Links-Akzent"
...
L["OPTIONS_FOCUS_PROPER"]                                             = "Erster Buchstabe groß"
...
L["PRESENCE_LEVEL_UP"]                                                = "LEVELAUFSTIEG"
...
L["PRESENCE_ACHIEVEMENT_EARNED"]                                      = "ERFOLG ERLANGT"
...
L["PRESENCE_WORLD_QUEST"]                                             = "WELTQUEST"
L["PRESENCE_WORLD_QUEST_COMPLETE"]                                    = "WELTQUEST ABGESCHLOSSEN"
L["PRESENCE_AZERITE_MINING"]                                          = "Azerit-Abbau"
L["PRESENCE_WORLD_QUEST_ACCEPTED"]                                    = "WELTQUEST ANGENOMMEN"
...
-- L["PRESENCE_DRAGON_GLYPHS_3_5"]                                    = "Dragon Glyphs: 3/5"  -- NEEDS TRANSLATION
...
-- =====================================================================
L["OPTIONS_VISTA_ZONE_TEXT_HEADER"]                                   = "Zonen-Text"
L["OPTIONS_VISTA_ZONE_FONT"]                                          = "Zonen-Schriftart"
L["OPTIONS_VISTA_FONT_ZONE_NAME_BELOW_MINIMAP"]                       = "Schriftart für den Zonennamen unter der Minikarte."
L["OPTIONS_VISTA_ZONE_FONT_SIZE"]                                     = "Zonen-Schriftgröße"
L["OPTIONS_VISTA_ZONE_TEXT_COLOR"]                                    = "Zonentext-Farbe"
L["OPTIONS_VISTA_COLOR_OF_ZONE_NAME_TEXT"]                            = "Farbe des Zonennamen-Texts."
L["OPTIONS_VISTA_COORDINATES_TEXT"]                                   = "Koordinaten-Text"
L["OPTIONS_VISTA_COORDINATES_FONT"]                                   = "Koordinaten-Schriftart"
L["OPTIONS_VISTA_FONT_COORDINATES_TEXT_BELOW_MINIMAP"]                = "Schriftart für den Koordinaten-Text unter der Minikarte."
L["OPTIONS_VISTA_COORDINATES_FONT_SIZE"]                              = "Koordinaten-Schriftgröße"
L["OPTIONS_VISTA_COORDINATES_TEXT_COLOR"]                             = "Koordinaten-Textfarbe"
L["OPTIONS_VISTA_COLOR_OF_COORDINATES_TEXT"]                          = "Farbe des Koordinaten-Texts."
L["OPTIONS_VISTA_COORDINATE_PRECISION"]                               = "Koordinaten-Genauigkeit"
