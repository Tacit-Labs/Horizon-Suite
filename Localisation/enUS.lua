...
L["AXIS_CLASS_THEME_DASHBOARD_DESC"]                          = "Master toggle for Dashboard class theming. Flipping it on enables Class Colours, Dashboard Class Icon, and Override Background together; each sub-option can then be adjusted independently."
