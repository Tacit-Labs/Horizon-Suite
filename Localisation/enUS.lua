...
L["AXIS_GLOBAL_TOGGLES"]                                      = "Global (Axis / Settings)"
...
L["AXIS_DASHBOARD_BG_CLASS_OVERRIDE_DESC"]                    = "Replace the Dashboard background with a class-themed background while Dashboard class colours are on."
