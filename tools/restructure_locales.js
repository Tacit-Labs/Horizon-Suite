#!/usr/bin/env node
/**
 * Sync locales/{locale}.lua to match locales/enUS.lua key order and sections.
...
function generateTemplate(entries, maxLhsLen) {
    ...
    lines.push('    Copy to locales/*.lua, set GetLocale() guard, translate values.');
    lines.push(']]');
    lines.push('');
...
console.log('Parsing locales/enUS.lua...');
