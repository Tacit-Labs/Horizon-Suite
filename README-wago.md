...
- **Global Toggles (Axis)** – Under **Axis → Global Toggles**, enable class tint per module or all at once (dashboard, Focus, Presence, Vista, Insight, Yield, Persona), pick a **dashboard background** preset (standard flat Default or Midnight with artwork), and set global UI scale (50–200%) or per-module scale sliders for Focus, Presence, Vista, Insight, and Yield.
