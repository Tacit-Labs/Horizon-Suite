...
-- L["DASH_WELCOME_ROADMAP_TOP_TITLE"]                        = "Coming Soon"
-- L["DASH_WELCOME_COMING_SOON_TAGLINE"]                      = "New welcome experiences are on the way."
-- L["DASH_WELCOME_ROADMAP_TOP_BODY"]                         = [=[Watch this space — we will post updates here and in |cffaaaaaaPatch Notes|r. Join |cffaaaaaaDiscord|r from the links below for news and feedback.]=]
...
-- L["CACHE_TOAST_TYPES"]                                     = "Toast Types"
-- L["CACHE_TOAST_TYPES_PAGE_DESC"]                           = "Choose which loot types trigger a toast notification."
-- L["CACHE_SHOW_ITEMS"]                                      = "Item Toasts"
-- L["CACHE_SHOW_ITEMS_DESC"]                                 = "Show a toast when you loot an item."
-- L["CACHE_SHOW_PUSHED_ITEMS"]                               = "Upgrade & Reward Toasts"
-- L["CACHE_SHOW_PUSHED_ITEMS_DESC"]                          = "Show a toast when an item is delivered to your bags (upgrades, Catalyst, quest rewards)."
-- L["CACHE_SHOW_MONEY"]                                      = "Money Toasts"
-- L["CACHE_SHOW_MONEY_DESC"]                                 = "Show a toast when you loot gold."
-- L["CACHE_SHOW_CURRENCY"]                                   = "Currency Toasts"
...
-- L["CACHE_PREVIEW_SECTION"]                                = "Preview"
-- L["CACHE_PREVIEW"]                                        = "Preview Toasts"
-- L["CACHE_PREVIEW_DESC"]                                   = "Fire a sample toast for each enabled type using your current settings."
-- L["CACHE_PREVIEW_PAGE_DESC"]                              = "Test the current toast layout with sample notifications."
-- L["CACHE_MIN_QUALITY"]                                     = "Minimum Item Quality"
-- L["CACHE_MIN_QUALITY_DESC"]                                = "Hide item toasts below this quality threshold."
-- L["CACHE_TOAST_OPACITY"]                                   = "Toast Opacity"
-- L["CACHE_TOAST_OPACITY_DESC"]                              = "Maximum opacity of loot toasts (%)."
-- L["CACHE_MAX_VISIBLE_SECTION"]                             = "Visibility"
-- L["CACHE_MAX_VISIBLE"]                                     = "Max Visible Toasts"
-- L["CACHE_MAX_VISIBLE_DESC"]                                = "Maximum number of loot toasts visible at once."
-- L["CACHE_HOLD_DURATIONS"]                                  = "Hold Durations"
-- L["CACHE_HOLD_DURATIONS_PAGE_DESC"]                        = "Configure how long each type of loot toast stays visible."
-- L["CACHE_HOLD_ITEM"]                                       = "Item Hold Time"
-- L["CACHE_HOLD_ITEM_DESC"]                                  = "How long Common, Uncommon, and Rare item toasts remain on screen (seconds)."
-- L["CACHE_HOLD_EPIC"]                                       = "Epic Hold Time"
-- L["CACHE_HOLD_EPIC_DESC"]                                  = "How long Epic item toasts remain on screen (seconds)."
-- L["CACHE_HOLD_LEGENDARY"]                                  = "Legendary Hold Time"
-- L["CACHE_HOLD_LEGENDARY_DESC"]                             = "How long Legendary item toasts remain on screen (seconds)."
-- L["CACHE_HOLD_MONEY"]                                      = "Money Hold Time"
-- L["CACHE_HOLD_MONEY_DESC"]                                 = "How long money toasts remain on screen (seconds)."
-- L["CACHE_HOLD_CURRENCY"]                                   = "Currency Hold Time"
-- L["CACHE_HOLD_CURRENCY_DESC"]                              = "How long currency toasts remain on screen (seconds)."
-- L["CACHE_HOLD_REP"]                                        = "Reputation Hold Time"
-- L["CACHE_HOLD_REP_DESC"]                                   = "How long reputation toasts remain on screen (seconds)."
-- L["CACHE_SOUNDS"]                                          = "Sounds"
-- L["CACHE_SOUNDS_PAGE_DESC"]                                = "Sound playback settings for loot toast notifications."
-- L["CACHE_SOUND_ENABLED"]                                   = "Enable Sounds"
-- L["CACHE_SOUND_ENABLED_DESC"]                              = "Master toggle for loot toast sounds."
-- L["CACHE_SOUND_CHANNEL"]                                   = "Sound Channel"
-- L["CACHE_SOUND_CHANNEL_DESC"]                              = "Audio mixer channel used for toast sounds."
-- L["CACHE_SOUND_CH_SFX"]                                    = "Sound Effects"
...
-- L["CACHE_SOUND_ITEMS"]                                     = "Item Sounds"
-- L["CACHE_SOUND_ITEMS_DESC"]                                = "Play a sound for epic and legendary item toasts."
-- L["CACHE_SOUND_MONEY"]                                     = "Money Sounds"
-- L["CACHE_SOUND_MONEY_DESC"]                                = "Play a sound when you loot gold."
-- L["CACHE_SOUND_CURRENCY"]                                  = "Currency Sounds"
-- L["CACHE_SOUND_CURRENCY_DESC"]                             = "Play a sound when you receive a currency."
-- L["CACHE_SOUND_REP"]                                       = "Reputation Sounds"
-- L["CACHE_SOUND_REP_DESC"]                                  = "Play a sound when your reputation changes."
-- L["CACHE_TYPOGRAPHY_PAGE_DESC"]                            = "Font and text display options for loot toasts."
-- L["CACHE_TEXT_OUTLINE"]                                    = "Text Outline"
-- L["CACHE_TEXT_OUTLINE_DESC"]                               = "Display toast text with an outline."
-- L["CACHE_FONT_SIZE"]                                       = "Font Size"
-- L["CACHE_FONT_SIZE_DESC"]                                  = "Text point size for loot toast labels (8–28)."
-- L["CACHE_TOAST_SCALE"]                                     = "Toast Scale"
-- L["CACHE_TOAST_SCALE_DESC"]                                = "Overall size multiplier for loot toasts (50–200%)."
