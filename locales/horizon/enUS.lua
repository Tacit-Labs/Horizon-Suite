...
L["ECHO_SAVE_HISTORY_DESC"]                                   = "Keep the last 100 whispers with each person between sessions, and reopen recent tiles after a reload. Switch on guild chat below to save that too. Messages the game hides are never saved."
L["ECHO_CLEAR_HISTORY"]                                       = "Clear history"
L["ECHO_CLEAR_HISTORY_DESC"]                                  = "Delete saved whispers and guild chat for every character and Battle.net friend."
L["ECHO_CLEAR_HISTORY_CONFIRM"]                               = "Delete Echo's saved whisper and guild chat history for every character? This can't be undone."
...
L["ECHO_SAVE_GUILD_DESC"]                                     = "Keep the last 200 guild lines between sessions, and reopen the Guild tile after a reload."
...
L["ECHO_HISTORY_DAYS_DESC"]                                   = "How long saved conversations are kept before Echo drops them. A pinned conversation is always kept. Takes effect at your next login."
