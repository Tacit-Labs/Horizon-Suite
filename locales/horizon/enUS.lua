...
-- Augment / FlightTimer — flight-path duration estimate + live timer bar mini-module.
...
-- The following are gossip-dialogue/subzone matching strings used to detect a handful of
-- NPC-triggered scenic flights, ported from InFlight (MIT licensed, see
-- modules/Augment/FlightTimer/THIRD_PARTY_LICENSE.txt) rather than translated fresh, since
-- they must match Blizzard's own localized zone/gossip text exactly to function.
