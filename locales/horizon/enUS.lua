...
L["FOCUS_INTEGRATION_RARE_MODEL_POSITION_DESC"]               = "Where the 3D portrait is displayed relative to the tracker entry."
L["FOCUS_INTEGRATION_RARE_MODEL_POSITION_RIGHT"]              = "Right (Inside Tracker)"
L["FOCUS_INTEGRATION_RARE_MODEL_POSITION_LEFT"]               = "Left (Outside Tracker)"
