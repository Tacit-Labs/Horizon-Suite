...
-- L["FOCUS_SLASH_HELP_RESET"]                                = "  /h focus reset      - Reset to live data"
-- L["FOCUS_SLASH_HELP_RESETPOS"]                             = "  /h focus resetpos   - Reset panel to default position"
...
-- L["FOCUS_SLASH_TESTITEM_INJECTED"]                         = "Injected one debug quest with a quest item (real quests remain). Use /h focus reset to clear."
