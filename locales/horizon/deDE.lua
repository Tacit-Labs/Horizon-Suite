...
-- L["INSIGHT_ACHIEVEMENT_POINTS_MODE_DESC"]                  = "Choose when to show achievement points. Only displayed on your own character's tooltip. Modifier shows it only while Shift is held."
