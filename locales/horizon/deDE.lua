...
-- L["INSIGHT_TRP3_BORDER_COLOR"]                                                  = "Custom Border Colour"
-- L["INSIGHT_TRP3_BORDER_COLOR_DESC"]                                             = "Tint the tooltip border with the player's TRP3 custom colour instead of their class colour."
...
-- L["INSIGHT_STATUS_BADGE_AFK_IN_HEADER"]                    = "AFK In Header"
-- L["INSIGHT_STATUS_BADGE_AFK_IN_HEADER_DESC"]               = "Show the AFK tag inline on the name line. When off, AFK appears with the other status badges."
