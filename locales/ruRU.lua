...
L["Enable Cache module"]                                                = "Включить модуль Cache"
...
L["Cache scale"]                                                        = "Масштаб Cache"
L["Scale for the Cache loot toast module (50–200%)."]                   = "Масштаб модуля уведомлений о добыче Cache (50–200%)."
