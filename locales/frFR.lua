...
L["Enable Cache module"]                                                = "Activer le module Cache"
...
L["Cache scale"]                                                        = "Échelle Cache"
L["Scale for the Cache loot toast module (50–200%)."]                   = "Échelle du module d'alerte de butin Cache (50–200 %)."
