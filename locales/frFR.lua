...
-- ── Axis > Profiles ────────────────────────────────────────────────────────────────
 ...
 L["Select the profile currently in use."]                               = "Selectionner le profil en cours d'utilisation."   
 L["Use global profile (account-wide)"]                                  = "Utiliser un profil global (pour tout le compte)"   
 L["All characters use the same profile."]                               = "Tous les personnages utiliseront le même profil."   
 L["Enable per specialization profiles"]                                 = "Activer les profils par Spécialisations"   
 L["Pick different profiles per spec."]                                  = "Choisit des profils différents suivant la spé."   
 L["Specialization"]                                                     = "Spécialisation"   
 L["Sharing"]                                                            = "¨Partager"   
 L["Import profile"]                                                     = "Importer un profil"   
 L["Import string"]                                                      = "Importer le code d'import"   
 L["Export profile"]                                                     = "Exporter le profil"   
 L["Select a profile to export."]                                        = "Selectionner un profil à exporter."   
 L["Export string"]                                                      = "Générer le code d'export"   
 L["Copy from profile"]                                                  = "Copier depuis un profil existant"   
 L["Source profile for copying."]                                        = "Profil à copier."   
 L["Copy from selected"]                                                 = "Copier le profil sélectionné"   
 L["Create"]                                                             = "Créer"   
 L["Create new profile from Default template"]                           = "Créer un nouveau profil par défaut"   
 L["Creates a new profile with all default settings."]                   = "Crée un nouveau profil avec des réglages par défaut."   
 L["Creates a new profile copied from the selected source profile."]     = "Crée un nouveau profil copié depuis le profil source sélectionné."   
 L["Delete profile"]                                                     = "Supprimer le profil"   
 L["Select a profile to delete (current and Default not shown)."]        = "Selectionner un profil à supprimer (Les profils Par Défaut et Actuel ne sont pas affichés)."   
 L["Delete selected"]                                                    = "Supprimer la sélection"   
 L["Delete selected profile"]                                            = "Supprimer le profil sélectionné"   
 L["Delete"]                                                             = "Supprimer"   
 L["Deletes the selected profile."]                                      = "Supprime le profil sélectionné."   
...
["When on, the FPS/latency text cannot be dragged."]                   = "Quand activé, le texte des FPS/latence ne peut plus être déplacé."  
